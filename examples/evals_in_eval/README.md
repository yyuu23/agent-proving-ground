...
This example demonstrates running AgentProvingGround evals (in Docker containers) inside an AgentProvingGround eval. The example involves installing AgentProvingGround itself in a container and instructing [Claude Code](https://docs.anthropic.com/en/docs/claude-code) as an AgentProvingGround agent to run evals.
...
| [Dockerfile](Dockerfile) | Dockerfile which installs Docker, AgentProvingGround, and Claude Code. |
