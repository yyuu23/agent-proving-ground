"""MLflow Tracing hook for AgentProvingGround.
...
To enable, set MLFLOW_TRACKING_URI and MLFLOW_APG_TRACING:

    export MLFLOW_TRACKING_URI="http://localhost:5000"
    export MLFLOW_APG_TRACING="true"
...
class MlflowTracingHooks(Hooks):
    ...
    Creates MLflow trace spans from AgentProvingGround evaluation events.
    ...
    def enabled(self) -> bool:
        return (
            ...
            and os.getenv("MLFLOW_APG_TRACING", "").lower() == "true"
        )

    async def on_run_start(self, data: RunStart) -> None:
        experiment_name = os.getenv("MLFLOW_EXPERIMENT_NAME", "agent_proving_ground")
