"""Example: run an AgentProvingGround eval with MLflow tracking and tracing.
...
os.environ["MLFLOW_APG_TRACING"] = "true"
...
from agent_proving_ground import Task, eval  # noqa: E402
from agent_proving_ground.dataset import Sample  # noqa: E402
from agent_proving_ground.scorer import match  # noqa: E402
from agent_proving_ground.solver import generate  # noqa: E402
...
def main():
    ...
    print("Running AgentProvingGround eval with MLflow tracking + tracing...")
