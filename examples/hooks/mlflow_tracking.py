"""MLflow Tracking hook for AgentProvingGround.
...
To enable, set MLFLOW_TRACKING_URI (and optionally MLFLOW_EXPERIMENT_NAME):
    ...
    export MLFLOW_EXPERIMENT_NAME="inspect-evals"  # defaults to "agent_proving_ground"
...
from agent_proving_ground.log import EvalSpec
...
class MlflowTrackingHooks(Hooks):
    ...
    Tracks AgentProvingGround evaluations in MLflow with a hierarchical structure:
    ...
    async def on_task_end(self, data: TaskEnd) -> None:
        ...
        if os.getenv("MLFLOW_APG_LOG_ARTIFACTS", "true").lower() != "false":
