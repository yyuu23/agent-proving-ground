...
Related to issue #2705: https://github.com/UKGovernmentBEIS/agent_proving_ground/issues/2705
"""
...
class TestModelEnvironmentMismatch:
    ...
    def test_azure_model_url_mismatch_logs_warning(
        ...
        mocker.patch("agent_proving_ground.model._providers.openai.AsyncAzureOpenAI")
        mocker.patch("agent_proving_ground.model._providers.openai.DefaultAsyncHttpxClient")
    ...
    def test_azure_matching_model_url_no_warning(self, monkeypatch, mocker, caplog):
        ...
        mocker.patch("agent_proving_ground.model._providers.openai.OpenAIAPI")
