...
from agent_proving_ground.agent import Agent, AgentState, agent, as_tool, handoff, react, run
from agent_proving_ground.agent._types import AgentPrompt
from agent_proving_ground.dataset import Sample
from agent_proving_ground.event import Timeline, timeline_build
from agent_proving_ground.event._timeline import TimelineSpan
...
from agent_proving_ground.util import collect
...
def scenario_sequential_run() -> tuple[str, Task, Any]:
    ...
    def researcher() -> Agent:
        async def execute(state: AgentState) -> AgentState:
            ...
            await anyio.sleep(0.15)
            from agent_proving_ground.model import get_model as _get_model
