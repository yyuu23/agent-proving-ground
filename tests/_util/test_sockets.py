"""Unit tests for :mod:`agent_proving_ground._util.sockets`."""
...
from agent_proving_ground._util.sockets import has_unix_sockets, parse_host_port
...
def test_prepare_socket_path_creates_parent(tmp_path) -> None:
    from agent_proving_ground._util.sockets import prepare_socket_path
...
def test_lock_socket_file_sets_owner_only_mode(tmp_path) -> None:
    ...
    from agent_proving_ground._util.sockets import SOCKET_FILE_MODE, lock_socket_file
...
def test_lock_socket_file_missing_path_is_noop(tmp_path) -> None:
    from agent_proving_ground._util.sockets import lock_socket_file
