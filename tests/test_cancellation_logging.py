...
from agent_proving_ground.solver import Generate, TaskState, generate, solver, user_message
...
def sandbox_kwarg(
    ...
    if request.param:
        ...
        monkeypatch.setattr(
            "agent_proving_ground._eval.task.run.sandboxenv_context", fake_sandboxenv_context
        )
        return "local"
    return None
