"""Tests for :func:`agent_proving_ground.log._transcript.track_store_changes`.
...
from agent_proving_ground.event import Event, StoreEvent
from agent_proving_ground.log._transcript import Transcript, init_transcript, track_store_changes
from agent_proving_ground.model import ChatMessageAssistant, ChatMessageUser
from agent_proving_ground.util import StoreModel
from agent_proving_ground.util._store import (
    Store,
    dict_jsonable,
    init_subtask_store,
    store_changes,
...
def test_track_store_changes_message_like_store() -> None:
    ...
    def build_store() -> Store:
        ...
        # Use real AgentProvingGround chat message types rather than ad-hoc models
