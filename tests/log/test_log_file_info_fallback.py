...
def _make_full_header(
    ...
    **eval_overrides: object,
    ...
    eval_section = {
        ...
        "packages": {"agent_proving_ground": "0.3.195"},
    }
...
class TestLogFileInfoNativeParse:
    """Baseline regression tests: native AgentProvingGround filenames with timestamp prefix.
...
class TestListEvalLogsIntegration:
    ...
    def test_mixed_filenames_all_resolve(self, tmp_path):
        ...
        from agent_proving_ground.log import list_eval_logs
