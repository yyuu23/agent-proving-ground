...
from agent_proving_ground.log._condense import ATTACHMENT_PROTOCOL
from agent_proving_ground.log._file import read_eval_log_async, write_eval_log_async
...
from agent_proving_ground.log._recorders.buffer import filestore as filestore_module
from agent_proving_ground.log._recorders.buffer import types as buffer_types_module
from agent_proving_ground.log._recorders.buffer.database import (
...
from agent_proving_ground.log._recorders.buffer.types import (
    AttachmentData,
    EventData,
    SampleData,
)
from agent_proving_ground.log._recorders.eval import LogStart
...
from agent_proving_ground.log._recover._buffer import (
    BufferRecoveryData,
...
def test_filestore_falls_back_when_tagging_denied(
    ...
    monkeypatch.setattr(
        "agent_proving_ground.log._recorders.buffer.filestore.open_file", fake_open_file
    )
...
async def test_streaming_recovery_preserves_full_sample_metadata(
    ...
    async with AsyncFilesystem():
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            from agent_proving_ground._eval.task import results as results_module
