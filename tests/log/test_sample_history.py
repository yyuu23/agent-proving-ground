...
from agent_proving_ground.event import InfoEvent, ModelEvent
from agent_proving_ground.log._log import EvalSample, EventsData
from agent_proving_ground.log._recorders.buffer.database import SampleBufferDatabase
from agent_proving_ground.log._recorders.streaming import materialize_streaming_sample
...
def test_pool_ref_registry_covers_all_ref_fields() -> None:
    ...
    from agent_proving_ground.event._pool import POOL_REF_FIELDS
    ...
    assert found == registered, (
        ...
        "agent_proving_ground.event._pool. Register new *_refs fields there (with "
