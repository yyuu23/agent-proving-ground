...
from agent_proving_ground._util.constants import DEFAULT_LOG_MODEL_API_CALLS
...
def test_transcript_bounded_env_escape_hatch(
    ...
    if value is not None:
        monkeypatch.setenv("APG_TRANSCRIPT_BOUNDED", value)
...
def test_transcript_subscriber_exception_does_not_skip_processing(
    ...
    with patch("agent_proving_ground.log._transcript.logger.warning") as warning:
        transcript._event(event)
