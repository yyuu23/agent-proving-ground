...
from agent_proving_ground.event import Event, Timeline, TimelineEvent, TimelineSpan
from agent_proving_ground.event._model import ModelEvent
from agent_proving_ground.event._pool import (
    _call_hash,
    _call_pool_json,
    _compress_refs,
    _expand_refs,
...
from agent_proving_ground.event._validate import validate_chat_messages
from agent_proving_ground.log._condense import (
    condense_events,
    condense_sample,
    expand_events,
    resolve_sample_attachments,
)
from agent_proving_ground.log._file import read_eval_log, read_eval_log_sample, write_eval_log
...
def test_read_sample_exclude_fields_preserves_events_data():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        from agent_proving_ground.log._file import read_eval_log_sample
...
def test_resolve_call_empty_refs_preserves_request():
    ...
    """
    from agent_proving_ground.event._pool import resolve_model_event_calls
