...
from agent_proving_ground.log import list_eval_logs, list_eval_logs_async
from agent_proving_ground.log._file import _walk_without_detail
...
def test_list_logs_async_remote_fs_trio(monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr("agent_proving_ground.log._file.filesystem", remote_style_filesystem)
