...
from agent_proving_ground.log._util import thin_input, thin_text
...
async def test_eval_recorder_summaries_computed_once(
    ...
    buffering many transcript-heavy samples (meridianlabs-ai/agent_proving_ground#116).
    """
...
async def test_summaries_json_reader_dedupes_duplicate_rows() -> None:
    ...
    from agent_proving_ground.log._recorders.eval import SUMMARIES_JSON
