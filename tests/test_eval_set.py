...
from agent_proving_ground._eval.evalset import (
...
from agent_proving_ground._eval.task.task import task_with
from agent_proving_ground._util.error import PrerequisiteError
from agent_proving_ground._util.file import basename, local_path, size_in_mb
from agent_proving_ground._util.json import to_json_str_safe
from agent_proving_ground.dataset import Sample
from agent_proving_ground.event import SampleInitEvent
from agent_proving_ground.log._edit import ProvenanceData, invalidate_samples
...
from agent_proving_ground.log._log import EvalConfig, EvalLog, EvalSampleSummary
...
from agent_proving_ground.model import CachePolicy, Model, get_model
...
from agent_proving_ground.scorer._match import includes
...
def test_generate_config_fields_classified():
    ...
    assert not unclassified, (
        ...
        f"src/agent_proving_ground/_eval/evalset.py and bump TASK_IDENTIFIER_VERSION.\n"
...
def test_eval_set_epochs_changed():
    ...
    with tempfile.TemporaryDirectory() as log_dir:
        ...
        with patch("agent_proving_ground._eval.task.log.iso_now") as mock_iso_now:
...
def test_eval_set_bundle_when_all_complete(tmp_path: Path) -> None:
    ...
    with patch("agent_proving_ground._eval.evalset.bundle_log_dir") as mock_bundle:
        success, logs = eval_set(
            tasks=[task1],
            log_dir=log_dir,
            model="mockllm/model",
...
def test_epochs_changed_same_reducer():
    ...
    """
    from agent_proving_ground._eval.task.epochs import Epochs
    from agent_proving_ground.scorer._reducer.reducer import mean_score
...
def test_embed_viewer_writes_on_change() -> None:
    ...
    with (
        patch("agent_proving_ground._eval.evalset.embed_log_dir"),
        patch("agent_proving_ground._eval.evalset.list_eval_logs") as mock_list,
        patch("agent_proving_ground._eval.evalset.write_log_listing") as mock_write,
    ):
