...
from agent_proving_ground._lfs._client import LFSDownloadInfo
from agent_proving_ground._lfs._pointer import LFS_POINTER_VERSION
from agent_proving_ground._lfs.exceptions import LFSResolverError
from agent_proving_ground._lfs.resolver import resolve_lfs_directory
...
_PATCH_FETCH = patch("agent_proving_ground._lfs._cache.fetch_download_urls")
_PATCH_DOWNLOAD = patch("agent_proving_ground._lfs._cache.download_lfs_object")
