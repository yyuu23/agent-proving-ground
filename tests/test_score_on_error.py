...
from agent_proving_ground._eval.task.run import PreviousError, eval_log_sample_source
...
from agent_proving_ground.log import EvalLog, recompute_metrics
...
def test_recompute_metrics_preserves_completed_samples():
    # score edits (and `apg score --action overwrite`) rebuild results from
