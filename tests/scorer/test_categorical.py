...
from agent_proving_ground.log import read_eval_log, recompute_metrics, write_eval_log
...
from agent_proving_ground.util import StrEnum
...
def test_categorical_resolves_enum_to_list() -> None:
    from agent_proving_ground._util.registry import registry_params
...
def test_no_reducer_rejects_explicit_reduced_metric_for_repeated_samples() -> None:
    from agent_proving_ground._eval.task.results import (
        ScorerInfo,
