...
import agent_proving_ground.scorer._math as math_module
...
from agent_proving_ground.scorer import CORRECT, INCORRECT, Target, math
from agent_proving_ground.scorer._math import (
    _answer_candidates,
    _MathLimitError,
    _MathParseError,
    _parse_candidate,
...
def test_math_scorer_matches_real_answer_corpus() -> None:
    ...
    from agent_proving_ground.scorer._math import _boxed_candidates
...
def test_security_payloads_do_not_execute_in_eval(
    ...
    monkeypatch.delenv("APG_TELEMETRY", raising=False)
    monkeypatch.delenv("APG_API_KEY_OVERRIDE", raising=False)
    monkeypatch.delenv("APG_REQUIRED_HOOKS", raising=False)
...
def test_scorer_runs_under_unguarded_top_level_entry() -> None:
    ...
    script = textwrap.dedent(
        ...
        from agent_proving_ground.scorer import Target, math
