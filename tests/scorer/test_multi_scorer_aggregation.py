...
from agent_proving_ground.scorer import Score, Target, mean, model_graded_qa, scorer
from agent_proving_ground.scorer._metric import SampleScore
from agent_proving_ground.scorer._multi import multi_scorer
...
def test_reducer_consistent_across_scorers() -> None:
    ...
    from agent_proving_ground.scorer._reducer import mean_score
