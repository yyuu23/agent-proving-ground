...
from agent_proving_ground.scorer._metrics import aggregate, grouped
...
def _scorer_info_for_dict_metrics() -> Any:
    from agent_proving_ground._eval.task.results import ScorerInfo
...
def test_dict_metric_unscored_samples_mixed():
    ...
    from agent_proving_ground._eval.task.results import scorers_from_metric_dict
