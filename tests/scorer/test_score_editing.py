...
from agent_proving_ground.scorer import Score, Target, accuracy, mean, scorer
...
def test_resolve_scorers_info_loads_task_file_metrics_once(
    ...
    import agent_proving_ground._eval.score as score_module
    from agent_proving_ground._eval.loader import load_file_tasks as real_load_file_tasks
    from agent_proving_ground._util.registry import _registry, registry_key
...
from agent_proving_ground.scorer import Metric, SampleScore, metric
