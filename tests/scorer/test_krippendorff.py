...
from agent_proving_ground.scorer import Score, krippendorff_alpha, value_to_float
...
def test_krippendorff_nominal_on_numeric_warns():
    alpha = krippendorff_alpha()
    with patch("agent_proving_ground.scorer._metrics.krippendorff.logger") as mock_logger:
