...
from agent_proving_ground.util._notify import apprise_scope
...
async def test_empty_config_dispatches_to_console_handler(
    ...
    from agent_proving_ground.util._input import console as console_module
...
async def test_dispatch_builtin_prefers_acp_when_available(
    ...
    from agent_proving_ground.util._input import acp as acp_module
    from agent_proving_ground.util._input import console as console_module
...
async def test_request_input_fires_notify_before_dispatch(
    ...
    # No active sample in this test → default title is `AgentProvingGround Agent`
...
async def test_request_input_emits_input_event_accepted(
    ...
    from agent_proving_ground.log import _transcript as transcript_module
