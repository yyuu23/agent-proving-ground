...
from agent_proving_ground._util.textual.form import ElicitationForm
from agent_proving_ground.util import InputRequest, InputResult
from agent_proving_ground.util._input.manager import (
    HumanQuestionManager,
    PendingQuestionRequest,
    init_human_question_manager,
)
from agent_proving_ground.util._input.panel import (
    QuestionInputPanel,
    QuestionRequestActions,
    QuestionRequestBody,
)
from agent_proving_ground.util._panel import InputPanel
...
async def test_panel_submit_resolves_with_accepted() -> None:
    ...
    init_human_question_manager()
    from agent_proving_ground.util._input.manager import human_question_manager
...
async def test_dispatch_falls_through_to_console_without_task_screen() -> None:
    ...
    import agent_proving_ground.util._input.builtin as builtin_module
    import agent_proving_ground.util._input.console as console_module
