...
from agent_proving_ground._cli.trace import anomalies_command_impl, http_command_impl
...
def test_trace_anomalies_unknown_event_goes_to_stderr(
    ...
    """
    from agent_proving_ground._cli.trace import trace_anomalies
    from agent_proving_ground._util.trace import ActionTraceRecord
