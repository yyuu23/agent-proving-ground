...
from agent_proving_ground.util._checkpoint.sandbox_paths import (
    SandboxBackupPaths,
...
async def test_unresolvable_home_skipped_with_warning(
    ...
    # `agent_proving_ground` sets `propagate=False` on its package logger once logging
    ...
    module_logger = logging.getLogger("agent_proving_ground.util._checkpoint.sandbox_paths")
