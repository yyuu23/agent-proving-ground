...
from agent_proving_ground.util._checkpoint import TokenInterval, TurnInterval
...
def test_normalize_false_vetoes() -> None:
    from agent_proving_ground.util._checkpoint.config import CheckpointDisabled
...
def test_true_defers_trigger_to_sample() -> None:
    ...
    from agent_proving_ground.util._checkpoint import CheckpointSampleConfig
