...
from agent_proving_ground._display.core.display import TaskProfile, TaskSpec, TaskWithResult
from agent_proving_ground._display.textual.widgets.tasks import COLUMN_SPACING, TasksView
from agent_proving_ground.log import EvalConfig
...
def test_overcap_name_truncates_to_max_and_keeps_spacer() -> None:
    ...
    """
    from agent_proving_ground._display.core.progress import (
        MAX_DESCRIPTION_WIDTH,
        progress_description,
    )
    from agent_proving_ground._display.textual.widgets.tasks import _with_spacing
