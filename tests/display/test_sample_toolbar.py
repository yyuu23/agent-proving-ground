...
from agent_proving_ground._display.textual.widgets.samples import SampleToolbar
...
def _interrupt_btn_visible(sample: SimpleNamespace | None, *, in_prompt: bool) -> bool:
    ...
    ``agent_proving_ground._display.textual.widgets.samples.SampleInfo.sync_sample`` so
