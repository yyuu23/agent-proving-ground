...
from agent_proving_ground._cli import score as score_cli
from agent_proving_ground._cli.score import score
from agent_proving_ground._eval.score import ScoreAction
from agent_proving_ground.log import read_eval_log_async, write_eval_log_async
...
async def test_score_stream_flushes_periodically(
    ...
    monkeypatch.setattr(
        "agent_proving_ground._cli.score.create_recorder_for_location", create_recorder
    )
    monkeypatch.setattr(score_cli, "init_eval_context", lambda *args, **kwargs: None)
    monkeypatch.setattr(score_cli, "print_results", lambda *args, **kwargs: None)
    monkeypatch.setattr(
