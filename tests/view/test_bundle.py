...
def test_bundle_hf_output_dir_allowed(monkeypatch) -> None:
    monkeypatch.setattr(
        "agent_proving_ground.log._bundle._check_hf_space_exists", lambda repo_id: False
    )
    monkeypatch.setattr(
        "agent_proving_ground.log._bundle._prepare_viewer", lambda *args, **kwargs: None
    )
    monkeypatch.setattr(
        "agent_proving_ground.log._bundle.copy_log_files", lambda *args, **kwargs: None
    )
    monkeypatch.setattr(
        "agent_proving_ground.log._bundle.write_log_listing", lambda *args, **kwargs: None
    )
    monkeypatch.setattr(
        "agent_proving_ground.log._bundle._push_bundle_to_hf", lambda *args, **kwargs: None
    )
