"""Task that produces mixed sample states for AgentProvingGround View testing.

Run with:
    apg eval tests/view/test_sample_list_states.py
...
from agent_proving_ground.scorer import Score, Target, includes, mean, scorer, stderr
from agent_proving_ground.solver import Generate, TaskState, solver
from agent_proving_ground.util import LimitExceededError
