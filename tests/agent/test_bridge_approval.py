...
from agent_proving_ground.agent._bridge._approval import MAX_CONSECUTIVE_REJECTIONS
from agent_proving_ground.agent._bridge.anthropic_api import inspect_anthropic_api_request
from agent_proving_ground.agent._bridge.bridge import agent_bridge
from agent_proving_ground.agent._bridge.completions import inspect_completions_api_request
from agent_proving_ground.agent._bridge.google_api import inspect_google_api_request
from agent_proving_ground.agent._bridge.responses import inspect_responses_api_request
from agent_proving_ground.agent._bridge.sandbox.bridge import _monitor_terminate
from agent_proving_ground.agent._bridge.sandbox.types import SandboxAgentBridge
from agent_proving_ground.agent._bridge.types import AgentBridge
from agent_proving_ground.agent._bridge.util import (
    bridge_generate,
...
from agent_proving_ground.model._compaction import CompactionTrim
...
def openai_bridge_agent(scaffold_saw: list[list[str]]) -> Agent:
    ...
    async def execute(state: AgentState) -> AgentState:
        ...
        from agent_proving_ground.model._openai import messages_to_openai
...
async def test_bridge_policies_replace_ambient_ones() -> None:
    ...
    from agent_proving_ground.approval import approval as approval_context
