...
1. Stubs an :class:`ActiveSample` with a live
   :class:`~agent_proving_ground.agent._acp.transport_live.LiveAcpTransport`.
...
4. Drives :func:`agent_proving_ground.util._input.acp.acp_handler` from the "agent
...
from agent_proving_ground.util import InputRequest
from agent_proving_ground.util._input.acp import acp_handler
...
async def test_elicitation_e2e_attach_after_fire(
    ...
    ``apg acp``), the shim parks on the elicitation registry's
