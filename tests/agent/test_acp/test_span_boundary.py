...
from agent_proving_ground.agent import Agent, AgentState, agent, as_solver, handoff, react, run
...
from agent_proving_ground.model import ChatMessageUser, get_model
...
def test_no_remaining_literal_agent_type_in_span_call_sites() -> None:
    ...
    src = Path("src/agent_proving_ground")
