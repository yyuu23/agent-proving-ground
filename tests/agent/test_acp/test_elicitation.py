...
from agent_proving_ground.agent._acp.transport import ElicitationRequest, acp_session
...
async def test_mark_active_session_client_fans_out_across_registries() -> None:
    ...
    """
    from agent_proving_ground.agent._acp.transport_live import _ElicitationClientRegistry
