...
from agent_proving_ground.agent._acp.inspect_ext import PLAN_RENDERING_META_KEY, PLAN_TOOL_NAMES
...
def test_plan_tool_names_includes_inspect_first_party_planners(name: str) -> None:
    """AgentProvingGround's first-party planning tools are recognized."""
