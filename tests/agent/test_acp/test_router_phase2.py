...
from agent_proving_ground.agent._acp.event_mapping import (
    _AcpEventRouter,
...
from agent_proving_ground.model import ChatMessageAssistant, ModelInfo, set_model_info
...
def test_message_id_derivation_is_deterministic() -> None:
    """Same AgentProvingGround uuid → same message_id (stable across runs)."""
...
# AgentProvingGround tools run inside sandboxed eval environments; their paths usually
...
def test_shell_execution_tools_remain_unmapped() -> None:
    ...
    AgentProvingGround tools run inside sandboxed eval environments (often remote
...
def test_first_model_event_emits_initial_system_and_user_messages() -> None:
    ...
    from agent_proving_ground.model import ChatMessageSystem, ChatMessageUser
...
def test_tool_messages_in_input_are_skipped() -> None:
    ...
    from agent_proving_ground.model import ChatMessageTool, ChatMessageUser
...
def test_user_source_none_is_carried_explicitly() -> None:
    ...
    from agent_proving_ground.model import ChatMessageUser
