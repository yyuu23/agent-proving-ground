...
from agent_proving_ground.agent._acp.transport import _NOOP_SESSION_ID, acp_session
...
from agent_proving_ground.log._samples import ActiveSample, active_sample
...
async def test_user_cancel_stamps_operator_sentinel_on_in_flight_model_event() -> None:
    ...
    from agent_proving_ground.event._model import OPERATOR_CANCEL_ERROR, ModelEvent
    from agent_proving_ground.log._transcript import init_transcript
    from agent_proving_ground.model._generate_config import GenerateConfig
    from agent_proving_ground.model._model_output import ModelOutput
