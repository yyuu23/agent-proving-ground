...
async def test_session_screen_switch_sample_returns_to_picker(
    ...
    on peer-side EOF.
    """
    from agent_proving_ground.agent._acp.tui.picker_screen import PickerScreen
...
async def test_action_interrupt_sends_cancel_when_agent_working(
    ...
    """
    from agent_proving_ground.agent._acp.tui.state import StatusState
...
def _seed_pending_elicitation(state: Any) -> None:
    ...
    from agent_proving_ground.agent._acp.tui.state import PendingElicitation
...
async def test_escape_with_elicitation_card_mounted_declines(
    ...
    """
    from agent_proving_ground.agent._acp.tui.widgets.elicitation_card import _ElicitationCard
...
async def test_escape_while_cancel_rpc_in_flight_does_not_clear_pending(
    ...
    from agent_proving_ground.agent._acp.tui.state import PendingCancel
    from agent_proving_ground.agent._acp.tui.widgets.cancel_card import _CancelCard
