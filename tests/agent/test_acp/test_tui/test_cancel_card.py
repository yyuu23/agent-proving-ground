...
from agent_proving_ground.agent._acp.inspect_ext import APG_CANCEL_SAMPLE_METHOD
from agent_proving_ground.agent._acp.tui.state import PendingCancel, SessionState
from agent_proving_ground.agent._acp.tui.widgets.cancel_card import (
    _BUTTON_ID_PREFIX,
    _CancelCard,
)
...
async def test_score_fires_cancel_rpc_with_correct_payload() -> None:
    ...
    assert method == APG_CANCEL_SAMPLE_METHOD
