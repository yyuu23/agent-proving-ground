...
from agent_proving_ground.agent._acp.tui.state import (
    MessageGroup,
    Segment,
    SessionState,
    StatusState,
...
from agent_proving_ground.agent._acp.tui.widgets import (
    MessageWidget,
    ToolCallWidget,
    TranscriptWidget,
)
from agent_proving_ground.agent._acp.tui.widgets._formatting import (
    format_duration as _format_duration,
)
from agent_proving_ground.agent._acp.tui.widgets.message import _ReasoningBlock
...
async def test_user_message_renders_user_chip_with_source_suffix() -> None:
    ...
    async with app.run_test() as pilot:
        ...
        from agent_proving_ground.agent._acp.tui.widgets._collapsible import (
...
async def test_long_message_text_gets_truncation_note() -> None:
    ...
    from agent_proving_ground.agent._acp.tui.widgets.message import (
...
async def test_assistant_with_reasoning_segment_mounts_reasoning_block() -> None:
    ...
    """
    from agent_proving_ground.agent._acp.tui.widgets._collapsible import CollapsibleContent
...
async def test_session_header_strips_first_path_segment_from_task() -> None:
    ...
    from agent_proving_ground.agent._acp.discovery import TargetAddress
    from agent_proving_ground.agent._acp.tui.client import SessionRow
    from agent_proving_ground.agent._acp.tui.widgets.header import SessionHeaderWidget
...
async def test_session_header_title_click_posts_back_to_picker() -> None:
    """Clicking ``apg acp`` on the session header posts BackToPicker.
...
async def test_session_header_meta_click_does_not_post_back_to_picker() -> None:
    """Only the ``apg acp`` title triggers BackToPicker — not the meta row."""
    from pathlib import Path
...
async def test_session_header_tokens_chip_updates_via_set_usage() -> None:
    ...
    from agent_proving_ground.agent._acp.discovery import TargetAddress
    from agent_proving_ground.agent._acp.tui.client import SessionRow
    from agent_proving_ground.agent._acp.tui.state import UsageState
    from agent_proving_ground.agent._acp.tui.widgets.header import SessionHeaderWidget
...
async def test_transcript_auto_scrolls_when_tool_output_grows_at_same_status() -> None:
    ...
    async with app.run_test() as pilot:
        ...
        from agent_proving_ground.agent._acp.tui.widgets.transcript import (
...
def test_palette_is_role_to_color_only_no_backgrounds() -> None:
    ...
    """
    from agent_proving_ground.agent._acp.tui.widgets.message import _PALETTE
...
def _pending_approval(req, event=None):
    ...
    from agent_proving_ground.agent._acp.tui.state import PendingApproval
...
async def test_approval_content_renders_diff_content_variant() -> None:
    ...
    from agent_proving_ground.agent._acp.tui.widgets.tool_call import _ApprovalContent
...
def test_fingerprint_changes_when_pending_approval_is_set() -> None:
    ...
    """
    from agent_proving_ground.agent._acp.tui.state import ToolCallState
    from agent_proving_ground.agent._acp.tui.widgets._fingerprint import (
...
def test_is_separator_block_matches_producer_shape() -> None:
    ...
    from agent_proving_ground.agent._acp.tui.widgets.tool_call import _is_separator_block
