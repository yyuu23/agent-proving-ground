...
from agent_proving_ground.agent import AgentState
from agent_proving_ground.agent._acp.event_mapping import _AcpEventRouter, replay_transcript
from agent_proving_ground.agent._acp.inspect_ext import TOOL_CALL_CANCELABLE_META_KEY
...
from agent_proving_ground.agent._bridge.util import bridge_generate, bridge_model_generate
...
from agent_proving_ground.tool._tool_call import ToolCall, ToolCallContent, ToolCallError
...
def test_real_tool_event_after_synth_start_is_update_not_duplicate() -> None:
    ...
    If an AgentProvingGround tool somehow does emit a ``ToolEvent`` for a call we already
