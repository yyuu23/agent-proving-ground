...
from agent_proving_ground.agent._acp import AcpTransport
...
from agent_proving_ground.event import InterruptEvent
...
async def test_react_no_submit_cancel_mid_tool() -> None:
    ...
    from agent_proving_ground.agent._react import react_no_submit
...
async def test_cancel_clears_pending_on_in_flight_events() -> None:
    ...
    try:
        ...
        from agent_proving_ground.event import ToolEvent
