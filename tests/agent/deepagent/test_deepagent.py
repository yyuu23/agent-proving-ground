...
from agent_proving_ground.agent import deepagent
from agent_proving_ground.agent._deepagent.prompt import CORE_BEHAVIOR
...
def test_deepagent_subagent_dispatch_includes_parallel_guidance() -> None:
    ...
    from agent_proving_ground.agent._deepagent.research import DEFAULT_RESEARCH_PROMPT
    from agent_proving_ground.agent._types import PARALLEL_TOOLS_PROMPT
...
def test_deepagent_custom_instructions() -> None:
    ...
    from agent_proving_ground.agent._deepagent.prompt import build_system_prompt
...
def test_deepagent_custom_prompt_with_placeholders() -> None:
    ...
    from agent_proving_ground.agent._deepagent.prompt import expand_prompt_placeholders
...
def test_deepagent_default_subagents() -> None:
    ...
    from agent_proving_ground.agent._deepagent.general import general
    from agent_proving_ground.agent._deepagent.plan import plan
    from agent_proving_ground.agent._deepagent.research import research
...
def test_deepagent_submit_prompt_included() -> None:
    ...
    from agent_proving_ground.agent._react import _prompt_to_system_message
    from agent_proving_ground.agent._types import DEFAULT_SUBMIT_PROMPT, AgentPrompt
...
def test_deepagent_submit_prompt_excluded_when_false() -> None:
    ...
    from agent_proving_ground.agent._react import _prompt_to_system_message
    from agent_proving_ground.agent._types import AgentPrompt
