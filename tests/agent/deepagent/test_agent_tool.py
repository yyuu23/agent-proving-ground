...
from agent_proving_ground.agent._deepagent.subagent import Subagent, subagent
...
class TestSkillComposition:
    ...
    def test_parent_skills_flow_to_subagent(self) -> None:
        from agent_proving_ground.tool import Skill
    ...
    def test_duplicate_skill_names_rejected(self) -> None:
        ...
        from agent_proving_ground.agent._deepagent.deepagent import _validate_skill_names
        from agent_proving_ground.tool import Skill
...
class TestExtractResult:
    def test_extract_result_with_content_text(self) -> None:
        ...
        from agent_proving_ground.agent._deepagent.agent_tool import _extract_result
...
class TestAgentToolParallelFlag:
    ...
    def test_explicit_serial_tool_forces_serial(self) -> None:
        from agent_proving_ground.tool import tool as tool_decorator
