...
from agent_proving_ground.agent._deepagent.prompt import (
    CORE_BEHAVIOR,
    MEMORY_INSTRUCTIONS,
...
from agent_proving_ground.agent._deepagent.subagent import subagent
...
class TestParallelToolsPrompt:
    ...
    def test_builtin_subagent_prompts_have_no_duplicate_line(self) -> None:
        from agent_proving_ground.agent._deepagent.general import DEFAULT_GENERAL_PROMPT
        from agent_proving_ground.agent._deepagent.plan import DEFAULT_PLAN_PROMPT
