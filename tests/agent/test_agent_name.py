...
from agent_proving_ground._eval.loader import as_solver_spec, solver_from_spec
...
from agent_proving_ground.agent import Agent, AgentState, agent, agent_with, handoff, react
from agent_proving_ground.agent._agent import agent_display_name
from agent_proving_ground.agent._as_solver import as_solver
from agent_proving_ground.agent._as_tool import sanitize_tool_name
from agent_proving_ground.tool._tool_description import tool_description
...
def test_react_rename_keeps_factory_identity_and_drives_handoff() -> None:
    ...
    assert spec.solver == "agent_proving_ground/react"
...
def test_registry_create_from_dict_with_name_param() -> None:
    ...
    obj = cast(
        ...
        registry_create_from_dict(
            {
                "type": "agent",
                "name": "agent_proving_ground/react",
