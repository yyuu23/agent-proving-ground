...
from agent_proving_ground.agent._filter import MessageFilter
from agent_proving_ground.agent._handoff import handoff
...
from agent_proving_ground.model import ChatMessageUser, ModelOutput, get_model
from agent_proving_ground.model._chat_message import (
    ChatMessage,
    ChatMessageAssistant,
    ChatMessageSystem,
)
from agent_proving_ground.scorer import Score, Target, accuracy, includes, scorer
from agent_proving_ground.solver import Generate, Solver, TaskState, solver
from agent_proving_ground.tool import Tool, ToolCall, tool
...
def test_remove_submit_tool_filters_reasoning_content():
    ...
    from agent_proving_ground.agent._react import _remove_submit_tool
