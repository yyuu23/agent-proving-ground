...
-> the request AgentProvingGround then sent to Gemini ended on a model turn and Gemini rejected it
...
from agent_proving_ground.agent._bridge.google_api_impl import messages_from_google_contents
