...
from agent_proving_ground.agent._bridge.responses_impl import (
...
def test_harvest_tool_namespaces_from_tool_search_output() -> None:
    from agent_proving_ground.agent._bridge.responses_impl import _harvest_tool_namespaces
...
def test_process_response_output_items_tool_search_call() -> None:
    ...
    from agent_proving_ground.model._openai_responses import assistant_internal
...
async def test_compaction_does_not_clear_tool_search() -> None:
    from agent_proving_ground.model import ChatMessage, ChatMessageUser
    from agent_proving_ground.model._compaction.edit import TOOL_RESULT_REMOVED, CompactionEdit
