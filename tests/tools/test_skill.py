...
from agent_proving_ground.tool import bash, skill
from agent_proving_ground.tool._tools._skill.read import SkillParsingError, _read_skill
from agent_proving_ground.tool._tools._skill.types import Skill
...
class TestSkillNameUniqueness:
    ...
    async def test_duplicate_names_in_install_skills(self) -> None:
        ...
        from agent_proving_ground.tool._tools._skill.install import install_skills
