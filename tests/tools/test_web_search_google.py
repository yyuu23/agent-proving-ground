...
from agent_proving_ground.tool._tools._web_search._google import google_search_provider
...
class TestGoogleSearchRendering:
    ...
    async def test_search_result_rendering(self):
        ...
        with (
            ...
            patch("agent_proving_ground.model._model.get_model") as mock_get_model,
            patch(
