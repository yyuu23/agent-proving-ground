...
from agent_proving_ground.tool._tool_info import INTERNAL_TOOL_TYPE
...
class TestNormalizeConfig:
    ...
    def test_normalize_config_deprecated_args(
        ...
        with patch(
            "agent_proving_ground.tool._tools._web_search._web_search.deprecation_warning"
        ):
    ...
    @patch("agent_proving_ground.tool._tools._web_search._web_search._get_config_via_back_compat")
...
class TestCreateExternalProvider:
    ...
    @patch(
        "agent_proving_ground.tool._tools._web_search._google.maybe_get_google_api_keys",
...
class TestOldSignatureVariants:
    ...
    @patch(
        "agent_proving_ground.tool._tools._web_search._web_search.maybe_get_google_api_keys",
        return_value=("fake-key", "fake-cse-id"),
    )
    @patch("agent_proving_ground.tool._tools._web_search._web_search.deprecation_warning")
