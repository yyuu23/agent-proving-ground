...
from agent_proving_ground.tool import ToolError, ask_user
from agent_proving_ground.tool._tool_def import tool_def_fields
from agent_proving_ground.util import InputResult
from agent_proving_ground.util._input import request as request_module
...
async def test_accepted_returns_json_string(
    ...
    # The tool imports request_input by name from agent_proving_ground.util, so
    # patch that binding too.
    import agent_proving_ground.tool._tools._ask_user as ask_user_module
