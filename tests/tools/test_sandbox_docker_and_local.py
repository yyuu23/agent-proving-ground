...
from agent_proving_ground.util._sandbox.self_check import self_check
...
async def test_self_check_docker_custom_nonroot(request) -> None:
    ...
    # The default docker-compose used in AgentProvingGround uses the root user in the container.
