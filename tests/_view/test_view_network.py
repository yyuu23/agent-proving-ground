...
from agent_proving_ground._view.fastapi_server import (
    VIEW_REQUEST_HEADER,
    VIEW_REQUEST_HEADER_VALUE,
    standalone_view_app,
    view_server,
)
from agent_proving_ground._view.network import (
    Authority,
    Origin,
    ViewerNetworkPolicy,
...
def test_custom_loopback_dns_origin_adds_host_authority() -> None:
    policy = _policy(
        trusted_origins=("HTTP://My-AgentProvingGround.:7575/",),
    )
...
def test_default_origin_ports_are_canonicalized() -> None:
    policy = _policy(trusted_origins=("https://AgentProvingGround.Example:443",))
...
def test_unsafe_bind_is_rejected_before_port_acquisition(
    ...
    view_module = importlib.import_module("agent_proving_ground._view.view")
    acquired = False
