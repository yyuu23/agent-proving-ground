...
from agent_proving_ground._util.citation import UrlCitation
...
from agent_proving_ground.model._compaction._compaction import _CompactionState, compaction
from agent_proving_ground.model._compaction.edit import CompactionEdit
from agent_proving_ground.model._compaction.memory import MEMORY_TOOL
...
from agent_proving_ground.model._trim import partition_messages, strip_citations
from agent_proving_ground.tool import ToolCall, ToolInfo
...
async def test_redacted_reasoning_total_ignores_messages_without_redacted_blocks(
    ...
    """
    from agent_proving_ground.model._compaction._compaction import (
...
async def test_summary_truncates_oversized_tool_output(
    ...
    import agent_proving_ground.model._model_info as _model_info
    from agent_proving_ground.model import ModelInfo
...
def test_truncate_middle_marker_at_seam() -> None:
    ...
    from agent_proving_ground.model._compaction.summary import (
        _TRUNCATION_MARKER,
        _truncate_middle,
    )
