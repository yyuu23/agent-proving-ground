...
from agent_proving_ground.model import StopCategory, StopDetails
...
def test_collect_stop_details_defensive_on_unexpected_shape(monkeypatch) -> None:
    warnings: list[str] = []
    monkeypatch.setattr(
        "agent_proving_ground.model._model_output.warn_once",
...
def test_anthropic_message_stop_details_mirrors_category() -> None:
    ...
    from agent_proving_ground.model._providers.anthropic import message_stop_details
...
def test_google_stop_details_from_safety_ratings() -> None:
    ...
    from agent_proving_ground.model._providers.google import google_stop_details
...
def test_openai_stop_details_from_refusal_text() -> None:
    ...
    from agent_proving_ground.model._openai import openai_stop_details
...
def test_responses_stop_details_from_refusal() -> None:
    ...
    from agent_proving_ground.model._openai_responses import responses_stop_details
...
def test_bedrock_stop_details_from_guardrail_trace() -> None:
    ...
    from agent_proving_ground.model._providers.bedrock import (
        ConverseResponse,
