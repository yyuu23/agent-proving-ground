...
from agent_proving_ground.model import ChatMessageAssistant, ChatMessageTool, ModelOutput
from agent_proving_ground.model._chat_message import ChatMessageUser
from agent_proving_ground.model._compaction.edit import _clear_reasoning
...
async def test_gemini_mixed_tools_round_trip_is_idempotent() -> None:
    ...
    a synthetic candidate. The second capture must produce equivalent AgentProvingGround
...
async def test_gemini_3_replay_after_dropping_a_tool_call() -> None:
    ...
    controlled error — never an AgentProvingGround-side crash.
    """
    api = GoogleGenAIAPI(
        model_name="gemini-3.1-pro-preview",
        base_url=None,
