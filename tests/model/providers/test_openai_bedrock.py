...
def test_bedrock_static_key_aws_var_fallback(
    ...
    # AWS-standard name resolves when the AgentProvingGround-convention name is unset
...
def test_bedrock_base_url_env(
    ...
    # both the AgentProvingGround-convention and AWS-standard base URL env vars are honored
