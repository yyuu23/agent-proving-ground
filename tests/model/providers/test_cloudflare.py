...
from agent_proving_ground.model import ChatMessageAssistant, ChatMessageUser, get_model
...
def test_cloudflare_token_reported_to_override_hook(
    ...
    from agent_proving_ground.model._providers.cloudflare import (
        CLOUDFLARE_API_KEY,
    ...
    monkeypatch.setenv("CLOUDFLARE_ACCOUNT_ID", "account-id")
    monkeypatch.setattr(
        "agent_proving_ground.hooks._hooks.override_api_key",
        override_api_key,
    )
