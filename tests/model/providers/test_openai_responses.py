...
from agent_proving_ground._util.constants import NO_CONTENT
from agent_proving_ground._util.content import ContentReasoning, ContentText
from agent_proving_ground.dataset import Sample
from agent_proving_ground.model import GenerateConfig, ModelOutput, get_model
from agent_proving_ground.model._chat_message import ChatMessageAssistant
from agent_proving_ground.model._openai_responses import (
    MESSAGE_ID,
    MESSAGE_PHASE,
    _openai_input_items_from_chat_message_assistant,
)
from agent_proving_ground.model._providers.openai_compatible import ModelInfo
from agent_proving_ground.solver import generate, use_tools, user_message
...
def test_image_generation_call_output():
    ...
    from agent_proving_ground._util.content import ContentImage
    from agent_proving_ground.model._openai_responses import _process_response_output_items
...
def test_fix_function_tool_parameters_string_to_dict():
    ...
    from agent_proving_ground.model._providers.openai_responses import (
...
def test_chat_messages_from_compact_response():
    ...
    from agent_proving_ground._util.content import ContentData
    from agent_proving_ground.model._chat_message import ChatMessageUser
    from agent_proving_ground.model._openai_responses import chat_messages_from_compact_response
...
def test_model_usage_from_compact_response():
    ...
    from agent_proving_ground.model._openai_responses import model_usage_from_compact_response
...
def test_extract_compaction_from_content_data():
    ...
    from agent_proving_ground._util.content import ContentData, ContentText
    from agent_proving_ground.model._openai_responses import _extract_compaction_from_content_data
...
async def test_openai_responses_phase_model_arg():
    ...
    from agent_proving_ground.model._providers.openai import OpenAIAPI
...
def test_web_search_to_tool_use_handles_missing_action() -> None:
    ...
    from agent_proving_ground.model._openai_responses import web_search_to_tool_use
...
def test_image_generation_round_trip_with_text():
    ...
    from agent_proving_ground._util.content import ContentImage, ContentText
    from agent_proving_ground.model._openai_responses import (
        _openai_input_items_from_chat_message_assistant,
        _process_response_output_items,
        init_sample_openai_assistant_internal,
...
def test_openai_responses_tools_deduplicates_image_modalities():
    ...
    from agent_proving_ground.model._generate_config import GenerateConfig, ImageOutput
    from agent_proving_ground.model._openai_responses import openai_responses_tools
...
def _todo_write_tool_info():
    ...
    from agent_proving_ground.tool._tool_info import ToolInfo
    from agent_proving_ground.tool._tools._todo_write import todo_write
...
def _update_plan_tool_info():
    from agent_proving_ground.tool._tool_def import ToolDef
    from agent_proving_ground.tool._tool_info import ToolInfo
    from agent_proving_ground.tool._tools._update_plan import update_plan
...
def test_should_swap_todo_write_gating():
    ...
    from agent_proving_ground.model._openai_responses import should_swap_todo_write
...
def test_non_canonical_todo_write_not_swapped():
    ...
    from agent_proving_ground.tool._tool_info import ToolInfo, ToolParams
...
def test_superset_todo_write_not_swapped():
    ...
    from agent_proving_ground.model._openai_responses import should_swap_todo_write
    from agent_proving_ground.tool._tool_info import ToolInfo, ToolParams
    from agent_proving_ground.util._json import JSONSchema, json_schema_dump
...
def test_todo_write_does_not_force_responses_routing():
    ...
    from agent_proving_ground.model._openai_responses import is_native_tool_configured
...
def test_tool_choice_maps_forced_todo_write():
    ...
    from agent_proving_ground.tool import ToolFunction
...
def test_visible_cot_encrypted_content_survives_bridge_round_trip():
    ...
    """
    from agent_proving_ground.agent._bridge.responses_impl import messages_from_responses_input
    from agent_proving_ground.model._openai_responses import REASONING_ENCRYPTED_CONTENT
    from agent_proving_ground.model._reasoning import reasoning_to_think_tag
