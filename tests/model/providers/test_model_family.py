...
from agent_proving_ground.model._providers.openai_compatible import OpenAICompatibleAPI
from agent_proving_ground.model._providers.openrouter import OpenRouterAPI
from agent_proving_ground.model._providers.util.hf_handler import HFHandler
...
async def test_openai_passes_family_separately_from_wire_name(
    ...
    monkeypatch.setattr(
        "agent_proving_ground.model._providers.openai.generate_responses",
...
async def test_openai_compatible_passes_family_separately_from_wire_name(
    ...
    monkeypatch.setattr(
        "agent_proving_ground.model._providers.openai_compatible.generate_responses",
        fake_generate_responses,
    )
    set_model_info("custom-alias", ModelInfo(family="gpt-5"))
...
async def test_openrouter_alias_uses_family_for_reasoning_replay() -> None:
    ...
    from agent_proving_ground.model._providers.openrouter import (
...
def test_hf_handler_uses_family_for_parsing_and_alias_for_output(
    ...
    monkeypatch.setattr(
        "agent_proving_ground.model._providers.util.hf_handler.model_specific_tool_parse",
        fake_parse,
    )
