...
from agent_proving_ground.model._model_info import MODEL_INFO_LOOKUP_API_KEY
...
def test_hf_trust_remote_code_default_false(monkeypatch) -> None:
    ...
    from agent_proving_ground.model._providers.hf import HuggingFaceAPI
...
def test_hf_api_key_reaches_model_and_tokenizer(
    ...
    module_name = "agent_proving_ground.model._providers.hf"
