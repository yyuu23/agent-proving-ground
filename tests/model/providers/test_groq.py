...
from agent_proving_ground.model._providers.groq import chat_tool_choice
from agent_proving_ground.tool import ToolFunction
from agent_proving_ground.util import json_schema
...
def test_chat_tool_choice_any_maps_to_required() -> None:
    # AgentProvingGround's tool_choice "any" means "use at least one tool" (force a tool call). Groq is
