...
from agent_proving_ground.model._internal import parse_content_with_internal
from agent_proving_ground.model._openai import openai_completion_params
...
async def test_chat_completions_forwards_config_extra_headers():
    ...
    from agent_proving_ground.model._providers.openai_completions import generate_completions
