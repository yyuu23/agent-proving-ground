...
def test_previous_assistant_id_pulled_from_metadata() -> None:
    from agent_proving_ground.model._providers.anthropic import _previous_assistant_message_id
...
async def test_diagnostics_captured_on_model_output_metadata(
    ...
    from agent_proving_ground.model._providers import anthropic as anthropic_mod
    from agent_proving_ground.model._providers.anthropic import model_output_from_message
