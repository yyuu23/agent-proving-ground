...
from agent_proving_ground.model._providers._vllm_lora import (
    LoRAAdapter,
    VLLMServer,
    _normalize_api_base,
    _vllm_servers,
...
from agent_proving_ground.model._providers.vllm import VLLMAPI
...
class TestVLLMAPIInit:
    ...
    @patch("agent_proving_ground.model._providers.vllm.get_adapter_rank", return_value=None)
    ...
    def test_lora_accumulation_across_adapters(self) -> None:
        ...
        with patch(
            "agent_proving_ground.model._providers.vllm.get_adapter_rank",
...
class TestVLLMAPIClose:
    ...
    @patch("agent_proving_ground.model._providers.vllm.get_adapter_rank", return_value=None)
    @patch("agent_proving_ground.model._providers.vllm.VLLMAPI._start_server")
...
class TestEnsureAdapterLoaded:
    ...
    def test_already_loaded_skips_http(self) -> None:
        ...
        with (
            patch(
                "agent_proving_ground.model._providers._vllm_lora._adapter_on_server"
            ) as mock_check,
            patch("agent_proving_ground.model._providers._vllm_lora._load_adapter") as mock_load,
        ):
...
async def test_vllm_base_and_lora_shared_server() -> None:
    ...
    """
    from agent_proving_ground.model._model import resolve_models
