...
from agent_proving_ground._util.citation import Citation, UrlCitation
from agent_proving_ground._util.content import (
    Content as ApgContent,
)
from agent_proving_ground._util.content import (
    ContentImage,
    ContentReasoning,
...
from agent_proving_ground.model import ChatMessageAssistant, ChatMessageTool
from agent_proving_ground.model._chat_message import ChatMessageUser
from agent_proving_ground.model._generate_config import BatchConfig, GenerateConfig
from agent_proving_ground.model._model import RetryDecision
from agent_proving_ground.model._providers._google_citations import (
    distribute_citations_to_text_parts,
)
from agent_proving_ground.model._providers.google import (
    GoogleGenAIAPI,
...
from agent_proving_ground.model._providers.util import OAUTH_PLACEHOLDER_API_KEY
from agent_proving_ground.model._providers.util.hooks import HttpHooks
from agent_proving_ground.scorer import includes
from agent_proving_ground.solver import use_tools
from agent_proving_ground.tool import (
    ToolCall,
    ToolInfo,
    ToolParam,
    ToolParams,
...
def test_distribute_citations_empty_citations_list() -> None:
    ...
    content: list[ApgContent] = [ContentText(text="Some text")]
...
def test_thought_signature_on_tool_call():
    ...
    # This simulates what AgentProvingGround stores after parsing a Gemini response
...
async def test_google_generate_http_timeout(
    ...
    with patch(
        "agent_proving_ground.model._providers.google.Client", return_value=mock_client
    ) as client:
        api = GoogleGenAIAPI(
...
async def test_google_generate_preserves_request_extra_headers() -> None:
    ...
    with patch("agent_proving_ground.model._providers.google.Client", return_value=mock_client):
        api = GoogleGenAIAPI(
            model_name="gemini-2.0-flash",
            base_url=None,
            api_key="test-key",
...
def _make_batcher_and_batch(job_state: JobState) -> tuple:
    ...
    from agent_proving_ground.model._generate_config import BatchConfig
    from agent_proving_ground.model._providers._google_batch import GoogleBatcher
    from agent_proving_ground.model._providers.util.batch import Batch, BatchRequest
...
def test_usage_metadata_folds_thoughts_into_output_tokens():
    ...
    from agent_proving_ground.model._providers.google import usage_metadata_to_model_usage
