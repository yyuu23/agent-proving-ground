...
from agent_proving_ground.model import RetryDecision, get_model
...
def test_base_should_retry_returns_false() -> None:
    from agent_proving_ground.model._model import ModelAPI
...
def test_openai_classify_rate_limit_429() -> None:
    ...
    from agent_proving_ground.model._openai import openai_classify_retry
...
def test_sagemaker_503_classifies_as_transient() -> None:
    ...
    from agent_proving_ground.model._providers.sagemaker import SagemakerAPI
...
def test_together_rest_unwraps_retry_error_and_classifies_429() -> None:
    ...
    from agent_proving_ground.model._providers.together import TogetherRESTAPI
