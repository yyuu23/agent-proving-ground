...
class TestGetModelInfo:
    ...
    def test_model_family_does_not_instantiate_provider(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "agent_proving_ground.model._model.get_model", fail_provider_resolution
        )
    ...
    def test_direct_lookup_does_not_poison_provider_resolved_lookup(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "agent_proving_ground.model._model.get_model",
...
class TestModelDataConsistency:
    ...
    def test_colliding_lookup_keys_agree_across_files(self) -> None:
        ...
        from agent_proving_ground.model._model_data import model_data
        from agent_proving_ground.model._model_data.model_data import (
            create_model_info,
            load_organizations_from_yaml,
            model_key,
        )
        from agent_proving_ground.model._model_info import _normalize_for_lookup
...
class TestResultCaching:
    ...
    def test_failed_lookup_only_runs_fuzzy_match_once(self, monkeypatch):
        ...
        from agent_proving_ground.model import _model_info as model_info_module
...
class TestDoesNotReinstantiateProvider:
    ...
    def _track_get_model(monkeypatch: Any) -> list[Any]:
        ...
        monkeypatch.setattr("agent_proving_ground.model._model.get_model", tracking_get_model)
        return calls
    ...
    def test_record_usage_does_not_instantiate_provider(self, monkeypatch):
        ...
        from agent_proving_ground.model._model import record_and_check_model_usage
