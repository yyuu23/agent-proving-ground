...
from agent_proving_ground._util import log_context
from agent_proving_ground._util.log_context import (
    SampleContextFilter,
...
def test_no_active_sample_passthrough(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(
        "agent_proving_ground.log._samples.sample_active", lambda: None, raising=True
    )
