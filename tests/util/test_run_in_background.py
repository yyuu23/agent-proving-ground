...
class TestRunInBackground:
    ...
    def test_trio_backend_raises_error(self):
        ...
        try:
            ...
            with patch(
                "agent_proving_ground._util.background.current_async_backend", return_value="trio"
            ):
    ...
    def test_no_async_context_raises_error(self):
        ...
        try:
            ...
            with patch(
                "agent_proving_ground._util.background.current_async_backend", return_value=None
            ):
