...
from agent_proving_ground.event import Event, SpanBeginEvent, SpanEndEvent, StoreEvent
...
def test_json_change_move_requires_from() -> None:
    ...
    from agent_proving_ground._util.json import JsonChange
    from agent_proving_ground.util._store import _json_change_to_patch_op
