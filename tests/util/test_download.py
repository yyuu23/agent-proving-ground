"""Tests for agent_proving_ground._util.download."""
...
from agent_proving_ground._util.download import download, gdrive_download
...
def test_skip_when_file_exists_with_matching_checksum(tmp_path: Path) -> None:
    ...
    with patch("agent_proving_ground._util.download.httpx.stream", stream_mock):
