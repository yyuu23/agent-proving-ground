...
from agent_proving_ground._util.async_zip import AsyncZipReader, CentralDirectory
from agent_proving_ground._util.asyncfiles import AsyncFilesystem
from agent_proving_ground._util.compression_transcoding import _DeflateCompressStream
from agent_proving_ground._util.zip_common import ZipCompressionMethod, ZipEntry
...
async def test_read_multi_frame_zstd_member(
    ...
    monkeypatch.setattr("agent_proving_ground._util.zipfile._MAX_INPUT_PER_FRAME", 64 * 1024)
