...
from agent_proving_ground.util._sandbox.registry import sandboxenv
...
def _warn_once_messages() -> Iterator[list[str]]:
    ...
    # triggered init_logger's propagate=False on the agent_proving_ground logger).
...
class TestResolveSandboxDockerCompatibility:
    ...
    async def test_sample_compose_yaml_forwarded_to_docker_compatible_task(self):
        ...
        from agent_proving_ground._eval.task.sandbox import resolve_sandbox
...
class TestResolveTaskSandboxDockerCompatibility:
    ...
    def test_task_compose_forwarded_to_docker_compatible_override(self, tmp_path):
        ...
        from agent_proving_ground._eval.loader import resolve_task_sandbox
        from agent_proving_ground._eval.task.constants import TASK_RUN_DIR_ATTR
...
class TestResolveSandboxForTaskAndSampleStartup:
    ...
    async def test_override_preserves_per_sample_compose_config(self, tmp_path):
        ...
        from agent_proving_ground._eval.loader import resolve_task_sandbox
        from agent_proving_ground._eval.task.constants import TASK_RUN_DIR_ATTR
        from agent_proving_ground._eval.task.sandbox import (
            resolve_sandbox,
