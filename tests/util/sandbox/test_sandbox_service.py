...
from agent_proving_ground.util._sandbox.limits import OutputLimitExceededError
from agent_proving_ground.util._sandbox.service import (
...
async def test_handle_request_incomplete_write_is_retried() -> None:
    ...
    with patch("agent_proving_ground.util._sandbox.service.logger") as mock_logger:
        await service._handle_request(request_file)
