...
from agent_proving_ground.util._span import (
    SpanRotationScope,
    current_span_id,
    span,
    span_id_provider,
)
from agent_proving_ground.util._store import Store, init_subtask_store, store
...
async def test_no_cross_context_warning_on_cross_task_rotation(
    ...
    # agent_proving_ground loggers don't propagate; attach caplog's handler directly
    span_logger = logging.getLogger("agent_proving_ground.util._span")
