...
def _isolate_terminal_source_caches() -> Iterator[None]:
    ...
    seconds (see ``agent_proving_ground._control.terminal_cache``). Tests in this suite
...
def short_data_dir(monkeypatch: pytest.MonkeyPatch) -> Iterator[Path]:
    ...
    monkeypatch.setattr("agent_proving_ground._control.discovery.inspect_data_dir", _stub)
