...
Covers the directive function in ``agent_proving_ground._control.limits`` (resolved
...
def _clear_states():
    from agent_proving_ground._control.config_record import reset_process_config_updates
...
async def test_limits_adaptive_semaphore_not_adjustable() -> None:
    ...
    from agent_proving_ground.util._concurrency import AdaptiveConcurrency, DynamicSampleLimiter
...
async def test_limits_max_sandboxes_adjustable_before_first_acquire() -> None:
    ...
    warning.
    """
    from agent_proving_ground._eval.task.sandbox import ensure_sandbox_limiter
    from agent_proving_ground.util._sandbox.local import LocalSandboxEnvironment
...
async def test_process_limits_read_only() -> None:
    from agent_proving_ground._control.limits import process_limits
...
def test_match_controllers_semantics() -> None:
    ...
    from agent_proving_ground._control.limits import _match_controllers
...
async def test_process_limits_key_retune() -> None:
    ...
    from agent_proving_ground._control.limits import process_limits
    from agent_proving_ground.util._concurrency import get_or_create_semaphore
...
async def test_limits_unknown_key_errors_before_other_knobs_apply() -> None:
    ...
    from agent_proving_ground._control.limits import UnknownConcurrencyKeyError
    from agent_proving_ground.util._concurrency import get_or_create_semaphore
...
async def test_limits_unknown_key_with_empty_registry() -> None:
    from agent_proving_ground._control.limits import UnknownConcurrencyKeyError, process_limits
...
def _app():
    from agent_proving_ground._control.server import ControlServer
...
async def test_post_mutation_routes_reject_unknown_param() -> None:
    ...
    from agent_proving_ground._control.server import keep_alive_intent, reset_keep_alive
...
async def test_strict_params_allow_sub_dependency_query_params() -> None:
    ...
    from agent_proving_ground._control.strict import (
...
async def test_config_update_records_key_change() -> None:
    ...
    from agent_proving_ground._control.config_record import inherited_config_updates
    from agent_proving_ground._control.limits import process_limits
    from agent_proving_ground.util._concurrency import get_or_create_semaphore
...
def test_process_scope_note() -> None:
    ...
    from agent_proving_ground._cli.ctl import _process_scope_note
...
def test_limits_route_error_becomes_500() -> None:
    ...
    from agent_proving_ground._control import server as server_mod
