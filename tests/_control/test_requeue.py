...
Covers the resolver (``agent_proving_ground._control.requeue.requeue_sample`` — the
decision table in ``design/ctl/sample-requeue.md``), the ``SampleScheduler`` /
``SampleRequeue`` runner machinery (``agent_proving_ground._eval.task.scheduler``),
...
from agent_proving_ground import SampleSource, Task, enqueue_sample, eval_async
...
from agent_proving_ground._display.core.display import TaskCancel
from agent_proving_ground._eval.task.error import SampleErrorHandler
from agent_proving_ground._eval.task.scheduler import (
    SampleRequeue,
    SampleScheduler,
    _ScheduledRun,
)
from agent_proving_ground._util._async import Wake
from agent_proving_ground._util.error import EvalError, is_cancellation_message
from agent_proving_ground.dataset import Sample
from agent_proving_ground.log import EvalLog, read_eval_log_async
from agent_proving_ground.log._log import EvalSample, EvalSampleSummary
from agent_proving_ground.scorer import CORRECT, Score, Target, accuracy, scorer
from agent_proving_ground.solver import Generate, TaskState, solver
from agent_proving_ground.util._display import init_display_type
...
def _patch_active_samples(monkeypatch: pytest.MonkeyPatch, samples: list[Any]) -> None:
    monkeypatch.setattr("agent_proving_ground.log._samples.active_samples", lambda: samples)
...
async def test_requeue_finished_during_resolver_reads_rejected(
    ...
    """
    import agent_proving_ground._control.state as control_state
