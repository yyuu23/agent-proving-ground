...
from agent_proving_ground._control.messages import _content_summary, _project, sample_messages
...
from agent_proving_ground.tool._tool_call import ToolCall, ToolCallError
...
async def test_running_attempt_invalidates_other_endpoints_cache(
    ...
    import agent_proving_ground.log._samples as samples_mod
    from agent_proving_ground._control.events import EventsSource
...
async def test_terminal_errored_sample_reports_error_status(
    ...
    import agent_proving_ground.log._samples as samples_mod
    from agent_proving_ground._control.eval_state import clear_all_eval_states, register_eval
    from agent_proving_ground.log import EvalError, EvalSample
