...
def test_retry_sweep_removes_log_and_invalidates_summaries_memo(tmp_path) -> None:
    ...
    from agent_proving_ground._eval.evalset import Log, latest_completed_task_eval_logs
    from agent_proving_ground.log import EvalLog, EvalSampleSummary
...
async def test_deferred_sample_stats_failure_keeps_provisional_split() -> None:
    ...
    """
    from agent_proving_ground._control.eval_state import register_completed_eval
    from agent_proving_ground._control.state import current_eval_summaries
