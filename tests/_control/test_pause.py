...
``agent_proving_ground._control.pause``, the directive functions (task pause/resume:
...
from agent_proving_ground.hooks import Hooks, TaskEnd, hooks
...
async def test_resume_fires_dispatch_wakers() -> None:
    ...
    from agent_proving_ground._control.pause import add_dispatch_waker, remove_dispatch_waker
...
def test_eval_task_pause_holds_queued_samples_until_resume(
    ...
    from agent_proving_ground._control.state import current_eval_summaries
...
class _ModelResumerHook(Hooks):
    ...
    async def on_task_end(self, data: TaskEnd) -> None:
        from agent_proving_ground._control.eval_state import get_eval_states
        from agent_proving_ground._control.pause import paused_models
