...
from agent_proving_ground._control.events import (
...
from agent_proving_ground.log import EvalError, Transcript
...
def _fake_running_sample(
    *,
    ...
    Carries just what :func:`agent_proving_ground._control.events._running_source` reads:
...
async def test_retry_on_error_cursor_does_not_skip_fresh_transcript(
    ...
    """
    import agent_proving_ground.log._samples as samples_mod
...
async def test_terminal_source_cache_expires_and_hits_do_not_refresh(
    ...
    """
    import agent_proving_ground._control.events as events_mod
    from agent_proving_ground._control.terminal_cache import TerminalSourceCache
...
async def test_running_attempt_invalidates_other_endpoints_cache(
    ...
    """
    import agent_proving_ground._control.events as events_mod
    import agent_proving_ground._control.messages as messages_mod
    import agent_proving_ground.log._samples as samples_mod
    from agent_proving_ground._control.messages import MessagesSource
...
def _register_buffered_eval(db: Any, location: str) -> None:
    ...
    buffer instance.
    """
    from agent_proving_ground._control.eval_state import register_eval
...
async def test_buffer_served_events_are_materialized(
    ...
    """
    from agent_proving_ground._control.eval_state import clear_all_eval_states
    ...
    from agent_proving_ground.model import ChatMessageUser, GenerateConfig, ModelOutput
...
async def test_buffer_torn_down_before_read_degrades(
    ...
    from agent_proving_ground._control.eval_state import clear_all_eval_states, register_eval
    from agent_proving_ground.log import TranscriptHistoryUnavailableError
