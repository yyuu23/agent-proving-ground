...
Covers the directive functions in ``agent_proving_ground._control.cancel`` (task cancel:
...
from agent_proving_ground._control.cancel import cancel_sample, cancel_task
...
from agent_proving_ground._display.core.display import CancelType, TaskCancel
