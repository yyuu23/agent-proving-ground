...
from agent_proving_ground._display.core.rich import rich_initialise
from agent_proving_ground._util._async import configured_async_backend, run_coroutine
from agent_proving_ground._util.platform import running_in_notebook
from agent_proving_ground._util.text import truncate
...
class PlainTaskDisplay(TaskDisplay):
    ...
    def _print_status(self) -> None:
        ...
        if self.progress_display.current != self.last_progress:
            ...
            # Add resource usage
            # Very similar to ``agent_proving_ground._display.core.footer.task_resources``, but without
