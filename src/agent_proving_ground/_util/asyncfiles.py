...
from agent_proving_ground._util.file import FileInfo, file, filesystem, local_path
...
def _log_s3_retry_attempt(location: str) -> Callable[[RetryCallState], None]:
    def log_attempt(retry_state: RetryCallState) -> None:
        from agent_proving_ground._util.retry import report_http_retry, sample_context_prefix
