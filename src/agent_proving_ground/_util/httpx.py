...
from agent_proving_ground._util.http import is_retryable_http_status, parse_retry_after
...
def log_httpx_retry_attempt(context: str) -> Callable[[RetryCallState], None]:
    def log_attempt(retry_state: RetryCallState) -> None:
        from agent_proving_ground._util.retry import sample_context_prefix
