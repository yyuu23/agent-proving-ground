...
def report_http_retry(
    ...
    """
    from agent_proving_ground.log._samples import report_active_sample_retry
    from agent_proving_ground.util._concurrency import _active_controller, _request_had_retry
