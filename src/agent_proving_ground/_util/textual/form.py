...
Display-agnostic: lives in `_util/textual` so both the main AgentProvingGround task
display (`agent_proving_ground/input/panel.py`) and the ACP TUI client
(`agent_proving_ground/agent/_acp/tui/`) can mount it without taking a dependency
on each other.
"""
...
from agent_proving_ground.util._input._validate import (
    PropertySchema,
    known_property,
    multiselect_options,
