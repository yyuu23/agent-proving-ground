...
Blob upload, GCS upload), and agent_proving_ground consolidates remote I/O on
:class:`~agent_proving_ground._util.asyncfiles.AsyncFilesystem` for proper async
...
Related helper: :func:`agent_proving_ground._util.file.write_atomic_text` provides
...
def atomic_write(
    ...
    Args:
        target_path: Final destination path. Must be local; remote paths
            ...
            :class:`~agent_proving_ground._util.asyncfiles.AsyncFilesystem` for
            remote writes.
