...
async def messages_from_openai_responses(
    ...
    """Convert OpenAI Responses API messages into AgentProvingGround messages.
...
async def model_output_from_openai(
    ...
    """Convert OpenAI ChatCompletion into AgentProvingGround `ModelOutput`
    ...
    from agent_proving_ground.model._openai import (
...
async def model_output_from_openai_responses(
    ...
    """Convert OpenAI `Response` into AgentProvingGround `ModelOutput`
    ...
    from agent_proving_ground.model._openai_responses import openai_responses_chat_choices
    from agent_proving_ground.model._providers.openai_responses import model_usage_from_response
