...
from agent_proving_ground.model._chat_message import ChatMessage, ChatMessageSystem
...
async def messages_from_anthropic(
    ...
    from agent_proving_ground.agent._bridge.anthropic_api_impl import (
...
async def model_output_from_anthropic(
    ...
    """Convert Anthropic Message response into AgentProvingGround `ModelOutput`
    ...
    from agent_proving_ground.model._providers.anthropic import model_output_from_message
