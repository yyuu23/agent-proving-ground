...
from agent_proving_ground.model._providers.util.util import split_system_messages
from agent_proving_ground.tool import ToolChoice, ToolFunction, ToolInfo
...
def mistral_reasoning_effort(
    ...
    """Map AgentProvingGround reasoning_effort onto Mistral's two-level scale.
