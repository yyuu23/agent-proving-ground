...
from agent_proving_ground.model._providers.openai_completions import (
...
from agent_proving_ground.model._retry import ModelRetryConfig, batch_admin_retry_config
...
# AgentProvingGround-convention name; AWS_BEDROCK_BASE_URL is the AWS-standard name, also
...
class OpenAIAPI(ModelAPI):
    def __init__(
        ...
        **model_args: Any,
        ...
        #
        # AgentProvingGround already preserves API-returned phase metadata by default.
