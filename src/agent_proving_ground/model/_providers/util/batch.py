...
from agent_proving_ground._util.constants import DEFAULT_BATCH_SIZE, DEFAULT_MAX_CONNECTIONS
from agent_proving_ground._util.notgiven import sanitize_notgiven
from agent_proving_ground.model._generate_config import BatchConfig
from agent_proving_ground.model._retry import ModelRetryConfig
...
class Batcher(Generic[ResponseT, CompletedBatchInfoT]):
    ...
    async def _batch_worker(self) -> None:
        from agent_proving_ground.log._transcript import Transcript, init_transcript
