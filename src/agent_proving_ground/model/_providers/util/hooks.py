...
from agent_proving_ground._util.http import parse_retry_after
...
class HttpHooks:
    ...
    def record_response(
        ...
        *,
        ...
        Args:
            request_id: The AgentProvingGround request id (from User-Agent / header).
...
class ConverseHooks(HttpHooks):
    # Key under which we stash the AgentProvingGround request_id on botocore's per-call
