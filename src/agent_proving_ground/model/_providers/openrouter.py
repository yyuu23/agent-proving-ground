...
from agent_proving_ground.model import _openrouter_reasoning
...
from agent_proving_ground.tool import ToolChoice
...
def _add_anthropic_cache_markers(request: dict[str, Any]) -> None:
    ...
    Mirrors the breakpoint placement used by agent_proving_ground's direct anthropic
    ...
    dashboard's Generation viewer, not the AgentProvingGround log.
    """
