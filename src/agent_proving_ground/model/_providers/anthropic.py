...
from agent_proving_ground._util.images import file_as_data, file_as_data_uri
...
from agent_proving_ground._util.url import data_uri_mime_type, data_uri_to_base64, is_http_url
from agent_proving_ground.log._samples import set_active_model_event_call
from agent_proving_ground.model._compaction.edit import (
    TOOL_RESULT_REMOVED,
    is_result_cleared,
)
...
from agent_proving_ground.util._json import (
...
class AnthropicAPI(ModelAPI):
    ...
    async def count_tokens(
        ...
        # Collapse consecutive user messages (as AgentProvingGround 'tool' messages become
    ...
    async def resolve_chat_input(
        ...
        # collapse user messages (as AgentProvingGround 'tool' messages become Claude 'user' messages)
...
def init_sample_anthropic_assistant_internal(value: JsonValue | None = None) -> None:
    ...
    ``agent_proving_ground.model._assistant_internal``.
    """
    if value is None:
...
def _names_for_tool_call(
    ...
    `str_replace_editor`. For a variety of reasons, AgentProvingGround's tool names to not
