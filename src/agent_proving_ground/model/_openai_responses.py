...
from agent_proving_ground._util.citation import Citation, DocumentCitation, UrlCitation
...
# The next two function perform transformations between OpenAI types an AgentProvingGround
...
def _chat_message_assistant_from_openai_response(
    ...
    """
    Transform OpenAI `Response` into an AgentProvingGround `ChatMessageAssistant` and `StopReason`.
...
def _synthetic_phase_for_assistant_message(
    ...
    #
    # AgentProvingGround always preserves OpenAI-returned MESSAGE_PHASE metadata. This
