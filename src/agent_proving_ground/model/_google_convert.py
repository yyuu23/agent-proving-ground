...
from agent_proving_ground.model._providers.providers import validate_google_client
...
async def messages_from_google(
    ...
    """Convert Google GenAI Content list into AgentProvingGround messages.
    ...
    Returns:
        List of AgentProvingGround ChatMessage objects.
    """
...
async def model_output_from_google(
    ...
    """Convert Google GenerateContentResponse into AgentProvingGround ModelOutput.
    ...
    Returns:
        AgentProvingGround ModelOutput object.
...
async def chat_message_from_google_content(
    ...
    if content.role == "model":
        ...
        messages: list[ChatMessage] = []
        pending_content: list[ApgContent] = []
...
async def content_from_google_parts(
    ...
    """Convert Google Parts to AgentProvingGround Content list.

    Args:
        parts: List of Google Part objects.

    Returns:
        List of AgentProvingGround Content objects.
    """
    content: list[ApgContent] = []
