...
if TYPE_CHECKING:
    from agent_proving_ground.model._model import Model  # noqa: F401
...
def get_model_info(model: str | Model) -> ModelInfo | None:
    ...
    AgentProvingGround model strings and performs case-insensitive matching.
    ...
    Args:
        model: Model name or Model instance. Standard AgentProvingGround model strings
...
def get_model_input_tokens(model: Model) -> int | None:
    from agent_proving_ground.model._compaction._compaction import DEFAULT_CONTEXT_WINDOW
...
def set_model_info(model: str, info: ModelInfo) -> None:
    ...
    Examples:
        ```python
        from agent_proving_ground.model import set_model_info, ModelInfo
