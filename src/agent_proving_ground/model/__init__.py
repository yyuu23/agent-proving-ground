...
relocated_module_attribute(
    "ToolCall", "agent_proving_ground.tool.ToolCall", _TOOL_MODULE_VERSION, _REMOVED_IN
)
relocated_module_attribute(
    "ToolChoice", "agent_proving_ground.tool.ToolChoice", _TOOL_MODULE_VERSION, _REMOVED_IN
)
relocated_module_attribute(
    "ToolFunction", "agent_proving_ground.tool.ToolFunction", _TOOL_MODULE_VERSION, _REMOVED_IN
)
relocated_module_attribute(
    "ToolParam", "agent_proving_ground.tool.ToolParam", _TOOL_MODULE_VERSION, _REMOVED_IN
)
relocated_module_attribute(
    "ToolInfo", "agent_proving_ground.tool.ToolInfo", _TOOL_MODULE_VERSION, _REMOVED_IN
)
