...
from agent_proving_ground._control.eval_state import (
    finalize_eval,
...
from agent_proving_ground._control.pause import PauseGatedSemaphore, dispatch_model_name
from agent_proving_ground._display import (
    TaskCancelled,
    TaskError,
    TaskProfile,
    TaskSuccess,
...
from agent_proving_ground._display.core.display import TaskCancel, TaskDisplayMetric
from agent_proving_ground._eval.task.scan import Scanners
from agent_proving_ground._util._async import Wake, aexit_shielded_when
from agent_proving_ground._util.async_zip import AsyncZipReader
from agent_proving_ground._util.asyncfiles import get_async_filesystem
...
from agent_proving_ground._util.error import (
    exception_message,
    is_cancellation_message,
)
from agent_proving_ground._util.exception import TerminateSampleError, TerminateTaskError
from agent_proving_ground._util.json import to_json_str_safe
from agent_proving_ground._util.notgiven import NOT_GIVEN
...
from agent_proving_ground._view.notify import view_notify_eval
from agent_proving_ground.dataset import Dataset, Sample
from agent_proving_ground.event._error import ErrorEvent
...
from agent_proving_ground.log._condense import condense_sample
from agent_proving_ground.log._file import (
    EvalLogInfo,
    eval_log_json_str,
...
from agent_proving_ground.log._recorders.eval import EvalRecorder, _sample_filename
from agent_proving_ground.log._recorders.streaming import (
    eval_retry_error_from_history,
    materialize_streaming_sample,
)
from agent_proving_ground.log._samples import (
    active_sample,
)
from agent_proving_ground.log._transcript import (
...
from agent_proving_ground.scorer import Scorer, Target
from agent_proving_ground.scorer._metric import Metric, SampleScore
from agent_proving_ground.scorer._reducer.types import ScoreReducer
from agent_proving_ground.scorer._score import init_scoring_context
from agent_proving_ground.scorer._scorer import unique_scorer_name
from agent_proving_ground.solver import Generate, Plan, TaskState
from agent_proving_ground.solver._chain import Chain, unroll
from agent_proving_ground.solver._fork import set_task_generate
from agent_proving_ground.solver._solver import Solver
from agent_proving_ground.solver._task_state import sample_state, set_sample_state, state_jsonable
from agent_proving_ground.util._anyio import inner_exception
from agent_proving_ground.util._checkpoint._layout import (
    eval_checkpoints_dir_from_config,
    has_sample_checkpoint,
    sample_checkpoints_dir,
)
from agent_proving_ground.util._checkpoint._layout.sample_checkpoints_dir import (
    scan_latest_committed_checkpoint,
)
from agent_proving_ground.util._checkpoint.checkpointer import ResumeCheckpoint
from agent_proving_ground.util._checkpoint.config import (
    CheckpointConfig,
    merge_checkpoint_configs,
)
from agent_proving_ground.util._early_stopping import (
    EarlyStop,
    EarlyStopping,
    EarlyStoppingSummary,
)
from agent_proving_ground.util._limit import (
    LimitExceededError,
...
from agent_proving_ground.util._limit import time_limit as create_time_limit
from agent_proving_ground.util._limit import turn_limit as create_turn_limit
from agent_proving_ground.util._limit import working_limit as create_working_limit
from agent_proving_ground.util._sandbox import SandboxTimeoutError
from agent_proving_ground.util._sandbox.context import sandbox_connections
from agent_proving_ground.util._sandbox.environment import SandboxEnvironmentSpec
from agent_proving_ground.util._sandbox.limits import reset_sandbox_limits, set_sandbox_limits
from agent_proving_ground.util._span import span
from agent_proving_ground.util._store import init_subtask_store
...
async def task_run(options: TaskRunOptions, task_cancel: TaskCancel | None) -> EvalLog:
    from agent_proving_ground.hooks._hooks import (
        emit_task_end,
        emit_task_start,
    )
    from agent_proving_ground.hooks._legacy import send_telemetry_legacy
...
def create_sample_semaphore(
    ...
    entry.
    """
    from agent_proving_ground.model._model import model_concurrency_key
