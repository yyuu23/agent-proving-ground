...
class SampleRequeue:
    ...
    async def checkpoint_available(self, sample_id: str | int, epoch: int) -> bool:
        ...
        if self._checkpoints_dir is None:
            return False
        from agent_proving_ground.util._checkpoint._layout import has_sample_checkpoint
    ...
    def accept(
        ...
        *and been re-read* first. Reconciliation: the prior terminal bucket is decremented
        ...
        progress and score.
        """
        from agent_proving_ground._control.eval_state import record_sample_requeued
