...
from agent_proving_ground._eval.task.util import split_spec
...
from agent_proving_ground.dataset import FieldSpec, Sample, hf_dataset
from agent_proving_ground.dataset._dataset import DatasetRecord
from agent_proving_ground.model import ChatMessageUser
from agent_proving_ground.scorer._scorer import Scorer, ScorerSpec
from agent_proving_ground.solver._solver import Solver, SolverSpec

if TYPE_CHECKING:
    from agent_proving_ground.model import ChatMessage
...
def task_create_from_hf(task_name: str, **kwargs: Any) -> list[Task]:
    ...
    from agent_proving_ground._eval.loader import scorer_from_spec, solver_from_spec
