...
if TYPE_CHECKING:
    from agent_proving_ground.scorer._scorers import Scorers

import anyio

from agent_proving_ground._display import display as display_manager
from agent_proving_ground._eval.context import init_task_context
from agent_proving_ground._eval.loader import load_file_tasks, scorer_from_spec
from agent_proving_ground._eval.task.task import resolve_scorer, resolve_scorer_metrics
from agent_proving_ground._util._async import configured_async_backend, run_coroutine, tg_collect
from agent_proving_ground._util.platform import platform_init, running_in_notebook
...
from agent_proving_ground.event._tree import (
    EventTreeSpan,
    event_sequence,
    event_tree,
    walk_node_spans,
...
from agent_proving_ground.log._condense import resolve_sample_attachments
from agent_proving_ground.log._log import EvalMetricDefinition, EvalSample
from agent_proving_ground.log._resolve import rebind_sample_timelines
from agent_proving_ground.log._score import _find_scorers_span
from agent_proving_ground.log._transcript import Transcript, init_transcript, transcript
from agent_proving_ground.model import ModelName
...
from agent_proving_ground.model._util import resolve_model_roles
from agent_proving_ground.scorer import Metric, Scorer, Target
from agent_proving_ground.scorer._metric import SampleScore, Score, metric_create
from agent_proving_ground.scorer._reducer import (
    ScoreReducer,
    ScoreReducers,
    create_reducers,
    reducer_log_names,
)
from agent_proving_ground.scorer._scorer import ScorerSpec, as_scorer_spec, unique_scorer_name
...
from agent_proving_ground.util._span import SCORER_SPAN_TYPE, SCORERS_SPAN_NAME, span
