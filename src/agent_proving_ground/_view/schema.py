"""Generate TypeScript types from agent_proving_ground Python models.

Generates OpenAPI schema and TypeScript types:
  EvalLog → inspect-openapi.json → openapi-typescript → generated.ts

Usage:
    python src/agent_proving_ground/_view/schema.py
"""
...
from agent_proving_ground._util.citation import Citation as _Citation
from agent_proving_ground._view._openapi import build_openapi_schema
from agent_proving_ground._view.fastapi_server import view_server_app
from agent_proving_ground.event._event import Event as _Event
from agent_proving_ground.model import ChatMessage as _ChatMessage
from agent_proving_ground.model import Content as _Content
from agent_proving_ground.tool._tool_choice import ToolChoice as _ToolChoice
...
def _generate_new() -> None:
    """Generate OpenAPI schema and TypeScript types for agent_proving_ground.
    ...
    """
    app = view_server_app()
    app.title = "agent_proving_ground types"
    app.version = "0.1.0"
