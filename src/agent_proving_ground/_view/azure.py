"""Azure-specific helpers used across AgentProvingGround view components."""

import os
from typing import Any, Callable

from agent_proving_ground._util.azure import is_azure_path
...
def azure_debug_exists(fs: Any, path: str, printer: Callable[[str], None]) -> None:
    ...
    if not (is_azure_path(path) and os.getenv("APG_AZURE_DEBUG")):
        return
    try:
