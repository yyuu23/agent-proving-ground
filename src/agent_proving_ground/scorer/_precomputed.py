...
from agent_proving_ground._util.registry import RegistryInfo, registry_name, registry_tag
...
def precomputed_scores(
    ...
    """Scorer that applies scores computed outside of AgentProvingGround.
    ...
    `score()` function or the `apg score` command. Samples with no
