...
socket. CLI clients (``apg ctl task list``, etc.) read this directory to
enumerate live evals.

The filesystem mechanics (PID-based JSON write with 0600, stale-PID
cleanup, dir 0700) come from :mod:`agent_proving_ground._util.discovery`; this
...
class DiscoveredControlServer:
    ...
    Represents one running AgentProvingGround process's control endpoint. The
