...
:mod:`agent_proving_ground._control.state`: flush a task's buffered completed samples to
...
:mod:`agent_proving_ground._control.limits`). Both are keyed by task_id — stable across
