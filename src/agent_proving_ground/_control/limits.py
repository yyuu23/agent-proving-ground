...
These knobs are backed by a :class:`~agent_proving_ground.util._concurrency.ResizableLimiter`
...
live override layer in :mod:`agent_proving_ground.model._generate_overrides` rather than
...
if TYPE_CHECKING:
    from agent_proving_ground.log._config_update import ConfigValueChange
...
async def process_limits(
    *,
    ...
    ``retry`` view and :mod:`agent_proving_ground.model._generate_overrides`; the
    ...
    change (see :mod:`agent_proving_ground._control.config_record`); the ``persisted``
    ...
    """
    from agent_proving_ground._control.config_record import record_config_changes
...
async def task_limits(
    ...
    *,
    ...
    attempt's live logger (see :mod:`agent_proving_ground._control.buffer`) — resolved
    ...
    Args:
        ...
        dry_run: When set, validate and report the intended change without
            applying it.
    """
    from agent_proving_ground._control.buffer import state_buffer_config
    from agent_proving_ground._control.config_record import record_config_changes
    from agent_proving_ground._control.eval_state import latest_eval_for_task
    from agent_proving_ground.log._config_update import ConfigValueChange
    from agent_proving_ground.util._concurrency import (
