...
if TYPE_CHECKING:
    ...
    from agent_proving_ground.agent._channel import ExecutionObserver
    from agent_proving_ground.hooks._hooks import SampleEvent
    from agent_proving_ground.log._log import EvalRetryError
    from agent_proving_ground.model._model_call import ModelCall, ModelCallFilter
...
from agent_proving_ground.util._checkpoint.checkpointer import CheckpointerSetup, ResumeCheckpoint
...
from agent_proving_ground.util._sandbox import SandboxConnection
...
class ActiveSample:
    def __init__(
        ...
        *,
        ...
        # The AgentProvingGround TUI reads this to decide whether to render the
...
async def active_sample(
    *,
    ...
    # (log → agent._acp → … → log).
    from agent_proving_ground.agent._acp.transport import acp_session
    ...
    try:
        ...
        # initializing.
        from agent_proving_ground._control.eval_state import record_sample_event_counts
...
def report_active_sample_refusal() -> None:
    ...
    Called alongside the process-global tally in :mod:`agent_proving_ground.log._refusal`.
