...
from agent_proving_ground._util.file import dirname, filesystem
...
def recoverable_eval_logs(
    ...
    Args:
        log_dir: Log directory (defaults to APG_LOG_DIR or ./logs).
...
async def _recoverable_eval_logs_async(
    ...
    log_dir = log_dir or os.environ.get("APG_LOG_DIR", "./logs") or "./logs"
