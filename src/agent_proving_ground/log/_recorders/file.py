...
from agent_proving_ground._util.file import clean_filename_component, filesystem
from agent_proving_ground._util.task import task_display_name
from agent_proving_ground.dataset._util import normalise_sample_id
...
async def write_local_snapshot(
    ...
    :mod:`agent_proving_ground._util.atomic_write`) means an interrupted write can't
...
class FileRecorder(Recorder):
    ...
    def _log_file_key(self, eval: EvalSpec) -> str:
        ...
        log_file_pattern = os.getenv("APG_EVAL_LOG_FILE_PATTERN", "{task}_{id}")
