...
from agent_proving_ground._util.download import download
...
def _download_archive(
    ...
    shared :func:`agent_proving_ground._util.download.download` helper, translating its
...
def _extract_expected_hash(sums_text: str, archive_name: str) -> str:
    ...
    raise RuntimeError(
        ...
        f"(see src/agent_proving_ground/util/_restic/README.md)."
    )
