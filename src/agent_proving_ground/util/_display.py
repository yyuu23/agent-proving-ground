...
from agent_proving_ground._util.constants import DEFAULT_DISPLAY
from agent_proving_ground._util.thread import is_main_thread
...
def init_display_type(display: str | None = None) -> DisplayType:
    ...
    display = (
        display or os.environ.get("APG_DISPLAY", DEFAULT_DISPLAY).lower().strip()
    )
