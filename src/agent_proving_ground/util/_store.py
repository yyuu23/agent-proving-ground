...
from agent_proving_ground._util.json import JsonChange, json_changes
...
def store_from_events(events: list["Event"]) -> Store:
    ...
    """
    from agent_proving_ground.event._store import StoreEvent
    from agent_proving_ground.event._tree import EventTreeSpan, event_tree
...
def store_from_events_as(
    ...
    """
    from agent_proving_ground.util._store_model import SMT as SMT_TypeVar  # noqa: F401
...
from agent_proving_ground.util._store_model import SMT  # noqa: E402
