...
class InputPanel(Container):
    """Base class for for AgentProvingGround input panels."""
...
async def input_panel(panel: type[TP]) -> TP:
    ...
    Raises:
       NotImplementedError: If AgentProvingGround is not running in display='full' model.
    """
    from agent_proving_ground._display.core.active import task_screen
