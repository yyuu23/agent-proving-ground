...
The submodules in ``agent_proving_ground.util._checkpoint._layout`` own the full
...
# `agent_proving_ground.event._event.Event`, which is itself the union that
...
# `from agent_proving_ground.util._checkpoint.layout import host_context`
