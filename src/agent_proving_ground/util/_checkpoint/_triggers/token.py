...
class _TokenIntervalTrigger:
    ...
    def tick(self) -> TriggerFire | None:
        ...
        # module is loaded during `agent_proving_ground.util._checkpoint`
        # package init, before `agent_proving_ground.model` finishes its own
        # init.
        from agent_proving_ground.model._model import sample_total_tokens
