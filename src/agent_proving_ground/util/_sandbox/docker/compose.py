...
from agent_proving_ground.util._concurrency import concurrency as concurrency_manager
from agent_proving_ground.util._display import display_type, display_type_plain
from agent_proving_ground.util._subprocess import ExecResult, subprocess
...
async def compose_command(
    ...
    *,
    ...
    docker_cli_concurrency = int(
        os.environ.get("APG_DOCKER_CLI_CONCURRENCY", DEFAULT_CLI_CONCURRENCY)
    )
