...
from agent_proving_ground._util._async import coro_log_exceptions
...
async def sandbox_service(
    ...
    for calling back into the main AgentProvingGround process.
    ...
    async def _handle_request(self, request_file: str) -> None:
        ...
        # all clear, call the method
            ...
            try:
                ...
                # agent_proving_ground module tree), which tells the agent it is running
