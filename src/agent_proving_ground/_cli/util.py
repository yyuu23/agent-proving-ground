...
from agent_proving_ground.model import GenerateConfig, Model, get_model
from agent_proving_ground.util._limit import TokenLimit, parse_token_limit
...
def parse_model_spec_cli_args(
    ...
    for index, spec in enumerate(model_spec, start=1):
        ...
        # APG_EVAL_MODEL, or raises a bare ValueError when that is unset too.
