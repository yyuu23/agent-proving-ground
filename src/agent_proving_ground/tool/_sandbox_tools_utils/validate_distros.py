...
Run from the agent_proving_ground source root or with the package installed.
"""
...
from agent_proving_ground.util._sandbox._cli import SANDBOX_TOOLS_BASE_NAME
