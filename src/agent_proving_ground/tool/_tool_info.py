...
from agent_proving_ground.util._json import JSONType, json_schema
...
:class:`~agent_proving_ground._util.content.ContentToolUse` ``tool_type`` literal
...
def internal_tool_type(tool: ToolInfo) -> str | None:
    ...
    Internal tools (:func:`~agent_proving_ground.tool.web_search`,
    :func:`~agent_proving_ground.tool.code_execution`, hosted MCP) set
