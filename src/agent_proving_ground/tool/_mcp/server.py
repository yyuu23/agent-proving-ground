...
def mcp_server_sse(
    *,
    ...
    Args:
        ...
        execution: Where to execute tool call ("local" for within the AgentProvingGround process, "remote" for execution by the model provider -- note this is currently only supported by OpenAI and Anthropic).
...
def mcp_server_sandbox(
    *,
    ...
    Interface to MCP server running in an AgentProvingGround sandbox.
