...
from agent_proving_ground._util.file import absolute_file_path
...
def log_viewer(
    ...
    URL mappings define the relationship between log file paths (either fileystem or S3) and URLs where logs are published. The URL target should be the location where the output of the [`apg view bundle`](../log-viewer.qmd#sec-publishing) command was published.
