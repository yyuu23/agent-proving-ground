...
defined in `agent_proving_ground.hooks` instead.
"""
...
# environment variable (e.g. APG_TELEMETRY='mypackage.send_telemetry')
...
# Telemetry (APG_TELEMETRY)
#
# Telemetry can be optionally enabled by setting an APG_TELEMETRY
...
# API Key Override (APG_API_KEY_OVERRIDE)
#
# API Key overrides can be optionally enabled by setting an
# APG_API_KEY_OVERRIDE environment variable which conforms to the
