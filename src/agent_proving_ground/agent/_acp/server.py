...
from agent_proving_ground.agent._acp._guards import (
...
from agent_proving_ground.agent._acp.discovery import default_socket_path, discovery_dir
from agent_proving_ground.agent._acp.inspect_ext import register_inspect_routes
...
class AcpServer:
    ...
    async def start(self) -> None:
        ...
        # need an asyncio loop. The rest of agent_proving_ground runs fine under
        ...
        if current_async_backend() == "trio":
            raise RuntimeError(
                ...
                "is asyncio-only. Either unset APG_ASYNC_BACKEND (default "
    ...
    async def _on_connection(
        ...
        # Register the AgentProvingGround extension methods (the ``inspect/*``
