...
Mid-stream inline rendering of AgentProvingGround-native transcript events
...
class EventChipWidget(Widget):
    """Inline chip for an AgentProvingGround-native transcript event."""
...
class _TracebackBlock(Widget):
    ...
    def compose(self) -> ComposeResult:
        ...
        # gives us the same styled rendering AgentProvingGround's own console
