...
from agent_proving_ground.agent._acp._guards import SendStatus, acp_guard, acp_send_guard
...
if TYPE_CHECKING:
    from agent_proving_ground.agent._acp.connection import ConnectionState
...
class Forwarders:
    ...
    def __init__(
        ...
        *,
        ...
        # AgentProvingGround extensions, fresh per-bind. The raw-event forwarder
