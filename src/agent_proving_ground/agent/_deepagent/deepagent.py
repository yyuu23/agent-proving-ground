...
from agent_proving_ground.model._compaction import CompactionAuto, CompactionStrategy
...
from agent_proving_ground.tool._tools._memory import memory as memory_tool
...
from agent_proving_ground.tool._tools._todo_write import todo_write as todo_write_tool
...
def _resolve_web_search(web_search: Tool | bool) -> Tool | None:
    ...
    if web_search is True:
        from agent_proving_ground.tool._tools._web_search import web_search as ws_factory
...
def _validate_skill_names(
    ...
    """
    from agent_proving_ground.tool._tools._skill import read_skills
