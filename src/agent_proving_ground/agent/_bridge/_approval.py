...
A bridged scaffold runs its own tool loop, so AgentProvingGround never executes its tool calls
...
the scaffold sees. AgentProvingGround can't stop a scaffold from running a tool it has been
...
async def apply_bridge_tool_approval(
    ...
    """
    from agent_proving_ground.approval._apply import apply_tool_approval, have_tool_approval
