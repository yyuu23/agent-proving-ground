...
from agent_proving_ground.model._generate_config import (
    GenerateConfig,
    ResponseSchema,
)
...
from agent_proving_ground.model._model import Model, ModelName
from agent_proving_ground.model._model_output import StopReason
...
from agent_proving_ground.model._providers._openai_computer_use import (
...
from agent_proving_ground.tool._tool_info import INTERNAL_TOOL_TYPE, ToolInfo
...
def messages_from_responses_input(
    ...
    for item in input:
        ...
        if is_agent_message(item):
            ...
            # https://github.com/UKGovernmentBEIS/agent_proving_ground/issues/4490).
