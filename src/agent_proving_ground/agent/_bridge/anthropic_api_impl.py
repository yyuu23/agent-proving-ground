...
from agent_proving_ground._util.content import Content, ContentDocument, ContentImage, ContentText
from agent_proving_ground._util.images import as_data_uri
...
from agent_proving_ground.model._internal import CONTENT_INTERNAL_TAG, parse_content_with_internal
from agent_proving_ground.model._model import ModelName
from agent_proving_ground.model._model_output import ModelUsage, StopReason
from agent_proving_ground.model._providers._anthropic_citations import to_inspect_citation
...
from agent_proving_ground.tool._tool_choice import ToolChoice, ToolFunction
from agent_proving_ground.tool._tool_info import ToolInfo
from agent_proving_ground.tool._tool_params import ToolParams
from agent_proving_ground.tool._tool_util import tool_to_tool_info
from agent_proving_ground.tool._tools._code_execution import (
    CodeExecutionProviders,
    code_execution,
)
from agent_proving_ground.tool._tools._computer._computer import computer
from agent_proving_ground.tool._tools._execute import bash
from agent_proving_ground.tool._tools._text_editor import text_editor
...
def tools_from_anthropic_tools(
    ...
    for anthropic_tool in anthropic_tools or []:
        if is_tool_param(anthropic_tool):
            ...
            # AgentProvingGround has no standalone fetch tool: on Anthropic, fetch rides
