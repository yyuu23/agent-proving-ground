...
`agent_proving_ground`) forwards provider errors to the proxied agent instead of crashing.
...
(`apg_sandbox_tools/_agent_bridge/proxy.py`) since the proxy cannot import
