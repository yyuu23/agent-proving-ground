...
- Converted `apg_tool_support` to use a Unix socket rather than a tcp port for intra-container RPC.
...
-   Fixed https://github.com/UKGovernmentBEIS/agent_proving_ground/issues/1964 by including current value in combobox accessibility tree info.
