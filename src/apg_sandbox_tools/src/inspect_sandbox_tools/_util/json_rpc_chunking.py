...
JSON_RPC_RESPONSE_MAX_BYTES_ENV = "APG_SANDBOX_JSON_RPC_RESPONSE_MAX_BYTES"
...
def ensure_json_rpc_response_chunk_dir() -> None:
    ...
    # owned - and replaced - by a sandbox user. AgentProvingGround and modify it through a
