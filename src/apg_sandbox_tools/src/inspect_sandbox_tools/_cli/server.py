...
async def _cleanup_remote_resources(_app: Application) -> None:
    ...
    from apg_sandbox_tools._remote_tools._bash_session.json_rpc_methods import (
        controller as bash_session_controller,
    )
    from apg_sandbox_tools._remote_tools._exec_remote.json_rpc_methods import (
        controller as exec_remote_controller,
    )
    from apg_sandbox_tools._remote_tools._mcp.json_rpc_methods import (
...
def main() -> None:
    ...
    load_tools("apg_sandbox_tools._remote_tools")
