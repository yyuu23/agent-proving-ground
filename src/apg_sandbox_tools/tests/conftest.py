"""Shared pytest fixtures and utilities for apg_sandbox_tools tests.
...
import pytest
from apg_sandbox_tools._util.constants import SOCKET_PATH
...
_SERVER_PROCESS_PATTERN = "apg_sandbox_tools._cli.main server"
...
def _exec_rpc_request_impl(
    ...
    result = subprocess.run(
        ["python", "-m", "apg_sandbox_tools._cli.main", "exec"],
        input=request_json,
        text=True,
        capture_output=True,
        timeout=timeout,
