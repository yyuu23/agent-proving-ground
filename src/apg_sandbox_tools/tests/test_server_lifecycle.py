...
from apg_sandbox_tools._cli import main as main_module
from apg_sandbox_tools._cli import server as server_module
from apg_sandbox_tools._remote_tools._bash_session import (
    json_rpc_methods as bash_session_methods,
)
from apg_sandbox_tools._remote_tools._exec_remote import (
    json_rpc_methods as exec_remote_methods,
)
from apg_sandbox_tools._remote_tools._mcp import json_rpc_methods as mcp_methods
from apg_sandbox_tools._util.constants import server_socket_path

SERVER_DIR_ENV = "APG_SANDBOX_TOOLS_DIR"
...
def _run_cli(
    ...
    *,
    ...
    result = subprocess.run(
        [sys.executable, "-m", "apg_sandbox_tools._cli.main", command],
...
def test_stop_server_bounds_inflight_request_shutdown() -> None:
    ...
    try:
        ...
        request_process = subprocess.Popen(
            [sys.executable, "-m", "apg_sandbox_tools._cli.main", "exec"],
