...
import apg_sandbox_tools._in_process_tools._text_editor.text_editor as text_editor_module
import pytest
from apg_sandbox_tools._in_process_tools._text_editor.text_editor import (
    _validated_path,
)
from apg_sandbox_tools._util.common_types import ToolException
...
def test_validated_path_rejects_too_long_filename() -> None:
    ...
    Regression: UKGovernmentBEIS/agent_proving_ground#3689 — a 5000-char path component
