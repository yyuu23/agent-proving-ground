...
Design for [meridianlabs-ai/agent_proving_ground#117](https://github.com/meridianlabs-ai/agent_proving_ground/issues/117).
...
2. **Destination durability / external readability**: the new attempt's
   ...
   Worse, `apg ctl task log-flush` is a **no-op** in this state today:
