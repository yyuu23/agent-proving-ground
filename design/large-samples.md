...
"[arbitrarily large samples in the viewer](https://github.com/epatey/agent_proving_ground/issues/1)"
...
[`scale-prototype` branch](https://github.com/epatey/agent_proving_ground/tree/scale-prototype)) —
...
- **2026-07-18 — Small-sample monolith threshold deferred indefinitely.**
  ...
  ([#17](https://github.com/epatey/agent_proving_ground/issues/17)) is dropped from the
...
- **⚠️ PROVISIONAL (live flow)** — everything about the live path: live-view
  unification ([#7](https://github.com/epatey/agent_proving_ground/issues/7)), the live
  byte source ([#9](https://github.com/epatey/agent_proving_ground/issues/9)), live
  skeleton/stats emission ([#19](https://github.com/epatey/agent_proving_ground/issues/19)).
...
1. **Merge to main early and often — no long-running branch. Absolute
   ...
   early merging safe. ([#18](https://github.com/epatey/agent_proving_ground/issues/18))
...
4. **Sealed logs = range reads only.** Consumption of a sealed log is purely
   ...
   can't have, so the format must not need it. ([#9](https://github.com/epatey/agent_proving_ground/issues/9))
...
## Chunked on-disk layout ([#4](https://github.com/epatey/agent_proving_ground/issues/4), [#6](https://github.com/epatey/agent_proving_ground/issues/6))
...
**Chunk-size envelope** (research, [#3](https://github.com/epatey/agent_proving_ground/issues/3)):
...
### Pools and attachments ([#6](https://github.com/epatey/agent_proving_ground/issues/6))
...
## Structural skeleton ([#5](https://github.com/epatey/agent_proving_ground/issues/5))
...
## Per-chunk event stats sidecar ([#5](https://github.com/epatey/agent_proving_ground/issues/5))
...
## Small-sample monolith threshold ([#17](https://github.com/epatey/agent_proving_ground/issues/17))
...
## Live-view unification ([#7](https://github.com/epatey/agent_proving_ground/issues/7))
...
## Live skeleton & stats availability ([#19](https://github.com/epatey/agent_proving_ground/issues/19))
...
([#8](https://github.com/epatey/agent_proving_ground/issues/8),
[proto/eval2-render](https://github.com/epatey/agent_proving_ground/tree/proto/eval2-render/prototypes/eval2-render)):
...
## Data-loading architecture ([#9](https://github.com/epatey/agent_proving_ground/issues/9))
...
## View-row pagination ([#8](https://github.com/epatey/agent_proving_ground/issues/8))
...
## Transcript search ([#10](https://github.com/epatey/agent_proving_ground/issues/10))
...
## Read primitives & `EvalSample` back-compat ([#12](https://github.com/epatey/agent_proving_ground/issues/12))
...
## Degradation policy for old-format huge samples ([#13](https://github.com/epatey/agent_proving_ground/issues/13))
...
## Downstream tooling matrix ([#14](https://github.com/epatey/agent_proving_ground/issues/14))
...
|---|---|---|
| `apg log list` / `headers` / `export-config` / `dump --header-only` | works-as-is | header/filesystem reads only |
...
| `apg log dump` | works-as-is + warning | hydrates at serialization; output is inherently sample-sized |
| `apg log convert` | works-as-is + warning | `--stream N` bounds cross-sample concurrency only; one monster sample fully materializes |
...
## Mid-sequence state/store reconstruction ([#16](https://github.com/epatey/agent_proving_ground/issues/16))
...
Standing section: AgentProvingGround features that are inherently inefficient or
...
# Part V — Phasing & compatibility ([#18](https://github.com/epatey/agent_proving_ground/issues/18))
...
`apg log convert-eval2` (naming will change with the `.eval2` name's
...
|---|---|---|
| Prior-art research | [#2](https://github.com/epatey/agent_proving_ground/issues/2) ([findings](https://github.com/epatey/agent_proving_ground/blob/research/prior-art-large-trace-viewers/design/research/prior-art-large-trace-viewers.md)) | 2026-07-18 |
| Zip/compression mechanics | [#3](https://github.com/epatey/agent_proving_ground/issues/3) ([findings](https://github.com/epatey/agent_proving_ground/blob/research/zip-chunked-log-mechanics/design/zip-chunked-log-mechanics.md)) | 2026-07-18 |
| Chunked on-disk layout | [#4](https://github.com/epatey/agent_proving_ground/issues/4) | 2026-07-18 |
| Structural skeleton | [#5](https://github.com/epatey/agent_proving_ground/issues/5) | 2026-07-18 |
| Attachments & pools | [#6](https://github.com/epatey/agent_proving_ground/issues/6) | 2026-07-18 |
| Live-view unification | [#7](https://github.com/epatey/agent_proving_ground/issues/7) | 2026-07-18 ⚠️ |
| Render prototype | [#8](https://github.com/epatey/agent_proving_ground/issues/8) ([FINDINGS](https://github.com/epatey/agent_proving_ground/blob/proto/eval2-render/prototypes/eval2-render/FINDINGS.md)) | 2026-07-18 |
| Viewer data loading | [#9](https://github.com/epatey/agent_proving_ground/issues/9) | 2026-07-18 (live source ⚠️) |
| Search | [#10](https://github.com/epatey/agent_proving_ground/issues/10) | 2026-07-18 |
| Python primitives & back-compat | [#12](https://github.com/epatey/agent_proving_ground/issues/12) | 2026-07-18 |
| Old-format degradation | [#13](https://github.com/epatey/agent_proving_ground/issues/13) | 2026-07-18 |
| Downstream tooling matrix | [#14](https://github.com/epatey/agent_proving_ground/issues/14) | 2026-07-18 |
| State/store reconstruction | [#16](https://github.com/epatey/agent_proving_ground/issues/16) | 2026-07-18 |
| Monolith threshold | [#17](https://github.com/epatey/agent_proving_ground/issues/17) | 2026-07-18 |
| Phasing & compat | [#18](https://github.com/epatey/agent_proving_ground/issues/18) | 2026-07-18 |
| Live skeleton/stats | [#19](https://github.com/epatey/agent_proving_ground/issues/19) | 2026-07-18 ⚠️ |
