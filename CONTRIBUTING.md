# Contributing to AgentProvingGround

Thanks for your interest in contributing to AgentProvingGround! We regularly accept contributions from the community and we're glad you want to help. To keep review capacity focused on work the project has agreed it wants, contributions follow a tiered policy. Please read this section first.
...
metrics, storage backends, example evals doesn't need to live in AgentProvingGround
core. AgentProvingGround has first-class extension APIs and an
...
## Reporting Bugs
Found a bug to report? Please [open an issue](https://github.com/UKGovernmentBEIS/agent_proving_ground/issues/new) with:
- A clear description of the problem
- Steps to reproduce
- Expected vs actual behavior
- Your environment (OS, Python version, AgentProvingGround version)

Before opening a new issue, please search [existing issues](https://github.com/UKGovernmentBEIS/agent_proving_ground/issues) to avoid duplicates.

## Finding an issue to work on
We use GitHub Issues to track open issues for AgentProvingGround. You can view all open issues on the project’s [Issues](https://github.com/UKGovernmentBEIS/agent_proving_ground/issues) tab on GitHub. We use the “good first issue” label to mark issues that might be easier for a first-time contributor to address. You can see issues marked “good first issue” by [filtering the Issues tab](https://github.com/UKGovernmentBEIS/agent_proving_ground/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22good%20first%20issue%22).
...
```
git clone https://github.com/UKGovernmentBEIS/agent_proving_ground.git
cd agent_proving_ground
pip install -e ".[dev]"
```
