...
from agent_proving_ground.tool import bash, text_editor
...
``` python
from agent_proving_ground.agent import react
from agent_proving_ground.model import CompactionAuto
from agent_proving_ground.tool import bash, text_editor
...
``` python
from agent_proving_ground.agent import react
from agent_proving_ground.model import CompactionNative
from agent_proving_ground.tool import bash, text_editor
...
``` python
from agent_proving_ground.agent import react
from agent_proving_ground.model import CompactionSummary
from agent_proving_ground.tool import bash, text_editor
...
``` python
from agent_proving_ground.agent import react
from agent_proving_ground.model import CompactionEdit
from agent_proving_ground.tool import bash, text_editor
...
``` python
from agent_proving_ground.agent import react
from agent_proving_ground.model import CompactionTrim
from agent_proving_ground.tool import bash, text_editor
...
from agent_proving_ground.agent import react
from agent_proving_ground.model import CompactionEdit
from agent_proving_ground.tool import bash, text_editor, memory
...
2. Context window sizes are computed using AgentProvingGround's built-in [model database](https://github.com/UKGovernmentBEIS/agent_proving_ground/tree/main/src/agent_proving_ground/model/_model_data), which includes context window sizes for popular commercial and open-source models. If the context window for a model cannot be determined then a warning is printed and a default context-window of 128,000 is utilized.
