...
from agent_proving_ground.scorer import perplexity, target_perplexity
...
``` bash
apg eval task.py --model vllm-completions/EleutherAI/pythia-70m --max-tokens 1 --prompt-logprobs 1
```
