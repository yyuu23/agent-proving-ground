...
1. It provides an OpenAI compatible API endpoint. In this scenario, use the AgentProvingGround [OpenAI Compatible API](providers.qmd#openai-api) interface.

2. It is available via OpenRouter (see the docs on using [OpenRouter](providers.qmd#openrouter) with AgentProvingGround).
