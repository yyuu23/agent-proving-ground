...
AgentProvingGround includes some simple built in metrics for calculating accuracy, mean, etc. Built in metrics can be imported from the `agent_proving_ground.scorer` module. Below is a summary of these metrics. See the [`agent_proving_ground.scorer`](reference/agent_proving_ground.scorer.qmd) reference for complete function signatures and options.
...
``` python
from agent_proving_ground.scorer import aggregate, mean, stderr
...
``` python
from agent_proving_ground.scorer import value_to_float
...
``` python
from agent_proving_ground.scorer import krippendorff_alpha, multi_scorer
...
from agent_proving_ground.scorer import Metric, Score, metric
...
AgentProvingGround includes several built in reducers which are summarised below.
