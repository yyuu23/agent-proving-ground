---
title: Task Views
llms-description: Use ViewerConfig to customize how a task's samples, scores, and scanner results render in the AgentProvingGround log viewer.
...
``` python
from agent_proving_ground.viewer import TaskSamplesView, ScoreColorScale
...
``` python
from agent_proving_ground.viewer import ViewerConfig, SampleScoreView, SampleScoreViewSort
...
See the [`agent_proving_ground.viewer`](reference/agent_proving_ground.viewer.qmd) reference for the complete field list of every type described here.
