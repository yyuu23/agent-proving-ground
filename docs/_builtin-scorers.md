AgentProvingGround includes both text matching scorers as well as model graded scorers. Below is a summary of these scorers. See the [`agent_proving_ground.scorer`](reference/agent_proving_ground.scorer.qmd) reference for complete function signatures and options.
