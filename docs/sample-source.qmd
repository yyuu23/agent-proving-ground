...
Sample sources require the development version of AgentProvingGround, which you can install from GitHub:
...
```python
from agent_proving_ground import SampleSource
...
```python
from agent_proving_ground import enqueue_sample
from agent_proving_ground.dataset import Sample
