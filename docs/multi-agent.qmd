...
There are several ways to implement multi-agent systems using the AgentProvingGround `Agent` protocol:
...
``` python
from agent_proving_ground.agent import Agent, AgentState, agent, run
...
``` python
from agent_proving_ground.agent import as_tool, react
...
``` python
from agent_proving_ground.agent react
from agent_proving_ground.tool import web_search
...
``` python
from agent_proving_ground.agent import remove_tools
...
``` python
from agent_proving_ground.agent import last_message
