...
``` bash
apg eval inspect_evals/gdm_intercode_ctf \
...
from agent_proving_ground.agent import human_cli
...
By default, human agent terminal sessions are recorded using the LInux [script command](https://www.redhat.com/en/blog/linux-script-command). Recorded sessions are saved in the sample store and available for playback within the AgentProvingGround View:
