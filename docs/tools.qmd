...
AgentProvingGround natively supports registering Python functions as tools and providing these tools to models that support them. AgentProvingGround also includes several standard tools for code execution, text editing, computer use, web search, and web browsing.
...
Tools exposed by MCP servers can be easily integrated into AgentProvingGround. Learn more in the article on [MCP Tools](tools-mcp.qmd). 
...
- [Standard Tools](tools-standard.qmd) describes AgentProvingGround's built-in tools for code execution, text editing computer use, web search, and web browsing.
